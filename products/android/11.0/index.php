...
<div class="tab" id="android-mobile-tab">
  ...
  <table>
    ...
    <tr>
      <td><img id="install-keyboard-ap" src="<?php echo cdn("img/app/11.0/globe-ap.png"); ?>"/></td>
      <td>Install or select another language/keyboard</td>
    </tr>
    <tr>
      <td><img id="hide-keyboard-ap" src="<?php echo cdn("img/app/11.0/hide-keyboard-ap.png"); ?>"/></td>
      <td>Hide the keyboard</td>
    </tr>
    <tr>
      <td><img id="backspace-ap" src="<?php echo cdn("img/app/11.0/backspace-ap.png"); ?>"/></td>
      <td>Backspace</td>
    </tr>
    <tr>
      <td><img id="return-ap" src="<?php echo cdn("img/app/11.0/return-ap.png"); ?>"/></td>
      <td>Return</td>
    </tr>
    <tr>
      <td><img id="shift-ap" src="<?php echo cdn("img/app/11.0/shift-ap.png"); ?>"/></td>
      <td>Shift key. Long press this key to access the CTRL, ALT and CTRL ALT keys
        (which can access additional key layers)
      </td>
    </tr>
    <tr>
      <td><img id="touch-hold-ap" src="<?php echo cdn("img/app/11.0/touch-hold-ap.png"); ?>"/></td>
    ...
    <tr>
      <td><img id="share-ap" src="<?php echo cdn("img/app/11.0/share-a.png"); ?>"/></td>
      <td>Share your text via Mail, Text, or Twitter</td>
    </tr>
    <tr>
      <td><img id="browser-ap" src="<?php echo cdn("img/app/11.0/browser-a.png"); ?>"/></td>
      <td>Open the Keyman Browser to use the web in your language</td>
    </tr>
    <tr>
      <td><img id="menu-ap" src="<?php echo cdn("img/app/11.0/menu-icon-a.png"); ?>"/></td>
      <td>Open the menu for additional options</td>
    </tr>
    <tr>
      <td><img id="font-size-ap" src="<?php echo cdn("img/app/11.0/font-size-a.png"); ?>"/></td>
      <td>Adjust the font size</td>
    </tr>
    <tr>
      <td><img id="delete-ap" src="<?php echo cdn("img/app/11.0/delete-a.png"); ?>"/></td>
      <td>Delete all current text</td>
    </tr>
    <tr>
      <td><img id="info-ap" src="<?php echo cdn("img/app/11.0/info-a.png"); ?>"/></td>
      <td>Load this help page</td>
    </tr>
    <tr>
      <td><img id="get-started-ap" src="<?php echo cdn("img/app/11.0/get-started-a.png"); ?>"/></td>
  ...
  <p>
    ...
    <br/>
    <img id="globe-ap" src="<?php echo cdn("img/app/11.0/globe-ap.png"); ?>"/>
    <br/>
    ...
    <br/>
    <img id="plus-ap" src="<?php echo cdn("img/app/11.0/plus-a.png"); ?>" />
    <br/><br/>
    Step 2)
    <br/>
    ...
    <br/>
    <img id="lang-list-ap" src="<?php echo cdn("img/app/11.0/lang-list-ap.png"); ?>"/>
    <br/><br/>
    ...
    <br/>
    <img id="confirm-dl-ap" src="<?php echo cdn("img/app/11.0/confirm-dl-ap.png"); ?>"/>
    <br/><br/>
    Step 3)
    <br/>
    Once the download is complete, the new keyboard will be selected. Touch the <span class="command">&larr;</span>
    button on the top left corner of the popup and the new keyboard will become active.
    <br/>
    <img id="success-ap" src="<?php echo cdn("img/app/11.0/dl-success-ap.png"); ?>"/>
    <br/><br/>
    ...
    <br/>
    <img id="close-keyman-ap" src="<?php echo cdn("img/app/11.0/close-keyman-a.png"); ?> "/>
    <br/>
  </p>
  ...
  <p>
    ...
    With the keyboard visible, touch the globe key:
    <br/>
    <img id="uninstall-keyboard-ap" src="<?php echo cdn("img/app/11.0/globe-ap.png"); ?>"/>
    <br/><br/>
    Step 2)
    <br/>
    A list of all available languages will appear. Scroll through this list until you find
    ...
    <br/>
    <img id="uninstall-list-ap" src="<?php echo cdn("img/app/11.0/uninstall-list-ap.png"); ?>"/>
    <br/><br/>
    Step 3)
    <br/>
    Long press the keyboard and release to get a prompt to delete the keyboard.
    <br/>
    <img id="uninstall-delete-ap" src="<?php echo cdn("img/app/11.0/uninstall-delete-ap.png"); ?>"/>
    <br/><br/>
    Step 4)
    Press "Delete" to uninstall the keyboard. You'll see a notification when the keyboard is deleted.
    <br/>
    <img id="uninstall-notification-ap" src="<?php echo cdn("img/app/11.0/uninstall-notification-ap.png"); ?>"/>
  </p>
  ...
  <p><img id="keyboard-help1-ap" src="<?php echo cdn("img/app/11.0/globe-ap.png"); ?>"/></p>
  <br/>
  <p>
    Step 2) Touch the info icon for your keyboard.
  </p>
  <p><img id="keyboard-help2-ap" src="<?php echo cdn("img/app/11.0/info-a-gray.png"); ?>"/></p>
  <br/>

  <h2>Installing System Wide Keyboards</h2>
  <p>
    Step 1) Open the Keyman app and select the menu for additional options.
    The screenshots below are of a device running Android 8.1 Oreo.
  </p>
  <p><img id="settings1-ap" src="<?php echo cdn("img/app/11.0/settings1-ap.png"); ?>"/></p>
  <br/>
  <p>
    Step 2) Select 'Get Started' and then select 'Enable Keyman as system-wide keyboard'.
  </p>
  <p><img id="settings2-ap" src="<?php echo cdn("img/app/11.0/settings2-ap.png"); ?>"/></p>
  <br/>
  <p>
    This will open an Android settings screen for 'Available virtual keyboard'.
  </p>
  <p><img id="settings3-ap" src="<?php echo cdn("img/app/11.0/settings3-ap.png"); ?>"/></p>
  <br/>
  <p>
    Step 3) Enable 'Keyman' as an available virtual keyboard.
    This will bring up two confirmation dialogs.
  </p>
  <p><img id="settings4-ap" src="<?php echo cdn("img/app/11.0/settings4-ap.png"); ?>"/></p>
  <br/>
  <p><img id="settings5-ap" src="<?php echo cdn("img/app/11.0/settings5-ap.png"); ?>"/></p>
  <br/>
  <p>
  ...
  <p><img id="settings6-ap" src="<?php echo cdn("img/app/11.0/settings6-ap.png"); ?>"/></p>
  <br/>
  <p>
    Click the keyboard icon whenever you want to change the current system keyboard.
  </p>
  <p><img id="settings7-ap" src="<?php echo cdn("img/app/11.0/settings7-ap.png"); ?>"/></p>
  <br/><br/>
  ...
  <p><img id="dist-url-screen-ap" src="<?= cdn('img/app/11.0/dist-url-screen-ap.png')?>"></p>
  <p>
  ...
  <p><img id="dist-downloads-ap" src="<?= cdn('img/app/11.0/dist-downloads-ap.png')?>"></p>
  <p>
  ...
  <p><img id="dist-file-browser-ap" src="<?= cdn('img/app/11.0/dist-file-browser-ap.png')?>"></p>
  <p>
  ...
  <p><img id="dist-storrage-permission-ap" src="<?php echo cdn("img/app/11.0/dist-storage-permission-ap.png"); ?>"/></p>
  <p>
  ...
  <p><img id="dist-welcome-ap" src="<?php echo cdn("img/app/11.0/dist-welcome-ap.png"); ?>"/></p>
  <p>
  ...
  <p><img id="dist-install1-ap" src="<?php echo cdn("img/app/11.0/dist-install1-ap.png"); ?>"/></p>
  <p>
    ...
    <a href="https://help.keyman.com/developer/11.0/guides/distribute/">click here</a>.
  </p>
  ...
  <p><img id="keyman-storage-permission-ap" src="<?php echo cdn("img/app/11.0/keyman-storage-permission-ap.png"); ?>"/></p>
...
<div class="tab selected-tab" id="android-tablet-tab">
  ...
  <table>
    ...
    <tr>
      <td><img id="install-keyboard-at" src="<?php echo cdn("img/app/11.0/globe-at.png"); ?>"/></td>
      <td>Install or select another language/keyboard</td>
    </tr>
    <tr>
      <td><img id="hide-keyboard-at" src="<?php echo cdn("img/app/11.0/hide-keyboard-at.png"); ?>"/></td>
      <td>Hide the keyboard</td>
    </tr>
    <tr>
      <td><img id="backspace-at" src="<?php echo cdn("img/app/11.0/backspace-at.png"); ?>"/></td>
      <td>Backspace</td>
    </tr>
    <tr>
      <td><img id="return-at" src="<?php echo cdn("img/app/11.0/return-at.png"); ?>"/></td>
      <td>Return</td>
    </tr>
    <tr>
      <td><img id="shift-at" src="<?php echo cdn("img/app/11.0/shift-at.png"); ?>"/></td>
      <td>Shift key. Long press this key to access the CTRL, ALT and CTRL ALT keys
        (which can access additional key layers)
      </td>
    </tr>
    <tr>
      <td><img id="touch-hold-at" src="<?php echo cdn("img/app/11.0/touch-hold-at.png"); ?>"/></td>
      <td>Keys with a small dot in the top right corner indicate a long press key. Access
        further functionality by long pressing the key
      </td>
    </tr>
    ...
    <tr>
      <td><img id="share-at" src="<?php echo cdn("img/app/11.0/share-a.png"); ?>"/></td>
      <td>Share your text via Mail, Text, or Twitter</td>
    </tr>
    <tr>
      <td><img id="browser-at" src="<?php echo cdn("img/app/11.0/browser-a.png"); ?>"/></td>
      <td>Open the Keyman Browser to use the web in your language</td>
    </tr>
    <tr>
      <td><img id="font-size-at" src="<?php echo cdn("img/app/11.0/font-size-a.png"); ?>"/></td>
      <td>Adjust the font size</td>
    </tr>
    <tr>
      <td><img id="delete-at" src="<?php echo cdn("img/app/11.0/delete-a.png"); ?>"/></td>
      <td>Delete all current text</td>
    </tr>
    <tr>
      <td><img id="info-at" src="<?php echo cdn("img/app/11.0/info-a.png"); ?>"/></td>
      <td>Load this help page</td>
    </tr>
    <tr>
      <td><img id="get-started-at" src="<?php echo cdn("img/app/11.0/get-started-a.png"); ?>"/></td>
      <td>Open the initial setup screen</td>
    </tr>
  </table>
  ...
  <p>
    ...
    With the keyboard visible, touch the globe key:
    <br/>
    <img id="globe-at" src="<?php echo cdn("img/app/11.0/globe-at.png"); ?>"/>
    <br/>
    This will bring up a list of all currently installed languages (the default is English
    EuroLatin (SIL)). If you have already downloaded additional languages, they will appear here.
    Simply select them and the keyboard will re-appear with the new language.
    ...
    button in the bottom right corner of your screen.
    <br/>
    <img id="plus-at" src="<?php echo cdn("img/app/11.0/plus-a.png"); ?>" />
    <br/><br/>
    Step 2)
    <br/>
    A list of all available languages will appear. Scroll through this list until you find
    ...
    example we have 10+ different Tamil keyboards.
    <br/>
    <img id="lang-list-at" src="<?php echo cdn("img/app/11.0/lang-list-at.png"); ?>"/>
    <br/><br/>
    ...
    <br/>
    <img id="confirm-dl-at" src="<?php echo cdn("img/app/11.0/confirm-dl-at.png"); ?>"/>
    <br/><br/>
    Step 3)
    <br/>
    Once the download is complete, the new keyboard will be selected. Touch the <span class="command">&larr;</span>
    button on the top left corner of the popup and the new keyboard will become active.
    <br/>
    <img id="success-at" src="<?php echo cdn("img/app/11.0/dl-success-at.png"); ?>"/>
    <br/><br/>
    Alternate Step for System Keyboard)
    <br/>
    The Keyman system keyboard has an additional <span class="command">CLOSE KEYMAN</span> button at the bottom left of
    the "Keyboards" menu. Pushing this button will close Keyman and switch to the next non-Keyman system keyboard.
    <br/>
    <img id="close-keyman-at" src="<?php echo cdn("img/app/11.0/close-keyman-a.png"); ?> "/>
    <br/>
  </p>
  ...
  <p>
    ...
    With the keyboard visible, touch the globe key:
    <br/>
    <img id="uninstall-keyboard-at" src="<?php echo cdn("img/app/11.0/globe-at.png"); ?>"/>
    <br/><br/>
    Step 2)
    <br/>
    A list of all available languages will appear. Scroll through this list until you find
    the keyboard you want to uninstall
    <br/>
    <img id="uninstall-list-at" src="<?php echo cdn("img/app/11.0/uninstall-list-at.png"); ?>"/>
    <br/><br/>
    Step 3)
    <br/>
    Long press the keyboard and release to get a prompt to delete the keyboard.
    <br/>
    <img id="uninstall-delete-at" src="<?php echo cdn("img/app/11.0/uninstall-delete-at.png"); ?>"/>
    <br/><br/>
    Step 4)
    Press "Delete" to uninstall the keyboard. You'll see a notification when the keyboard is deleted.
    <br/>
    <img id="uninstall-notification-at" src="<?php echo cdn("img/app/11.0/uninstall-notification-at.png"); ?>"/>
  </p>
  ...
  <p><img id="keyboard-help1-at" src="<?php echo cdn("img/app/11.0/globe-at.png"); ?>"/></p>
  <br/>
  <p>
    Step 2) Touch the info icon for your keyboard.
  </p>
  <p><img id="keyboard-help2-at" src="<?php echo cdn("img/app/11.0/info-a-gray.png"); ?>"/></p>
  <br/>
  ...
  <p><img id="settings1-at" src="<?php echo cdn("img/app/11.0/settings1-at.png"); ?>"/></p>
  <br/>
  <p>
    Step 2) Select 'Get Started' and then select 'Enable Keyman as system-wide keyboard'.
  </p>
  <p><img id="settings2-at" src="<?php echo cdn("img/app/11.0/settings2-at.png"); ?>"/></p>
  <br/>
  <p>
    This will open an Android settings screen for 'Available virtual keyboard'.
  </p>
  <p><img id="settings3-at" src="<?php echo cdn("img/app/11.0/settings3-at.png"); ?>"/></p>
  <br/>
  <p>
    Step 3) Enable 'Keyman' as an available virtual keyboard.
    This will bring up two confirmation dialogs.
  </p>
  <p><img id="settings4-at" src="<?php echo cdn("img/app/11.0/settings4-at.png"); ?>"/></p>
  <br/>
  <p><img id="settings5-at" src="<?php echo cdn("img/app/11.0/settings5-at.png"); ?>"/></p>
  <br/>
  <p>
  ...
  <p><img id="settings6-at" src="<?php echo cdn("img/app/11.0/settings6-at.png"); ?>"/></p>
  <br/>
  <p>
    Click the keyboard icon whenever you want to change the current system keyboard.
  </p>
  <p><img id="settings7-at" src="<?php echo cdn("img/app/11.0/settings7-at.png"); ?>" /></p>
  <br/><br/>
  ...
  <p><img src="<?= cdn('img/app/11.0/dist-url-screen-at.png')?>"></p>
  <p>
    Step 2) Browse to the KMP file. Once the KMP file is on your device, you will need to browse to the KMP file and select it.
    If using the Chrome browser, select the Menu, then "Downloads", and select the downloaded KMP file.
  </p>
  <p><img id="dist-downloads-at" src="<?= cdn('img/app/11.0/dist-downloads-at.png')?>"></p>
  <p>
    Otherwise, use the "Downloads" or file browser app available on your Android device to select the downloaded KMP file.
    If your default file browser doesn't prompt for Keyman to open the package file, you may need to use a different file
    browser from the Google Play store.
  </p>
  <p><img id="dist-file-browser-at" src="<?= cdn('img/app/11.0/dist-file-browser-at.png')?>"></p>
  <p>
    Selecting the KMP file should bring you to Step 3)
  </p>
  <p>
  ...
  <p><img id="dist-storage-permission-at" src="<?php echo cdn("img/app/11.0/dist-storage-permission-at.png"); ?>"/></p>
  <p>
    Older versions of Android grant Storage permissions at app installation time, so those users can skip this step.
  </p>
  <p>
  ...
  <p><img id="dist-welcome-at" src="<?php echo cdn("img/app/11.0/dist-welcome-at.png"); ?>"/></p>
  <p>
    If "welcome.htm" is not included, a generic page with the package ID and package version will be shown. Click the
    left "Install" button to install the entire keyboard package.
  </p>
  ...
  <p><img id="dist-install1-at" src="<?php echo cdn("img/app/11.0/dist-install1-at.png"); ?>"/></p>
  <p>
    Once the keyboard has been downloaded, you should be able to use it as normal.
    <br/>
    To learn how to create a custom installable keyboard,
  ...
  <p><img id="keyman-storage-permission-at" src="<?php echo cdn("img/app/11.0/keyman-storage-permission-at.png"); ?>"/></p>
