...
<p>
  ...
  <img id="settings-language-ap" src="<?= cdn("img/app/13.0/settings-language-ap.png")?>">
</p><p>
  Step 3)
</p><p>
  ...
  <img id="plus-a" src="<?= cdn("img/app/13.0/plus-a.png")?>">
</p><p>
  Step 4)
</p><p>
  ...
  <img class="phone" id="lang-list-ap" src="<?= cdn("img/app/13.0/lang-list-ap.png")?>">
  <img class="tablet" id="lang-list-at" src="<?= cdn("img/app/13.0/lang-list-at.png")?>">
</p><p>
  ...
  <img class="phone" id="confirm-dl-ap" src="<?= cdn("img/app/13.0/confirm-dl-ap.png")?>">
  <img class="tablet" id="confirm-dl-at" src="<?= cdn("img/app/13.0/confirm-dl-at.png")?>">
</p><p>
  Step 5)
</p><p>
  ...
  <img class="phone" id="success-ap" src="<?= cdn("img/app/13.0/dl-success-ap.png")?>">
  <img class="tablet" id="success-at" src="<?= cdn("img/app/13.0/dl-success-at.png")?>">
</p><p>
  ...
  <img id="close-keyman-a" src="<?= cdn("img/app/13.0/close-keyman-a.png")?> "/>
</p>
