...
<p>
  ...
  <img src="<?= cdn('img/app/11.0/dist-url-screen-i.png')?>">
  <br/>
  Safari will display an option to open the KMP file with Keyman<br/>
  <img src="<?= cdn('img/app/11.0/dist-kmp-open-i.png')?>">
  <br/><br/>
