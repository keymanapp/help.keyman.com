...
<p>
   ...
   <table>
       ...
       <tr>
           <td><img src="<?php echo cdn("img/app/10.0/globe.png"); ?>" /></td>
           <td>Install or select another language/keyboard</td>
       </tr>
       <tr>
           <td><img src="<?php echo cdn("img/app/10.0/hide-keyboard.png"); ?>" /></td>
           <td>Hide the keyboard</td>
       </tr>
       <tr>
           <td><img src="<?php echo cdn("img/app/10.0/backspace.png"); ?>" /></td>
           <td>Backspace</td>
       </tr>
       <tr>
           <td><img src="<?php echo cdn("img/app/10.0/return.png"); ?>" /></td>
           <td>Return</td>
       </tr>
       <tr>
           <td><img src="<?php echo cdn("img/app/10.0/shift.png"); ?>" /></td>
           <td>Shift key. Long press this key to access the CTRL, ALT and CTRL ALT keys (which can access additional
             key layers)</td>
       </tr>
       <tr>
           <td><img src="<?php echo cdn("img/app/10.0/touch-hold.png"); ?>" /></td>
       ...
       <tr>
           <td><img src="<?php echo cdn("img/app/10.0/share.png"); ?>" /></td>
           <td>Share your text via Mail, Text, Facebook or Twitter</td>
       </tr>
       <tr>
           <td><img src="<?php echo cdn("img/app/10.0/browser-icon.png"); ?>" /></td>
           <td>Open the Keyman Browser</td>
       </tr>
       <tr>
           <td><img src="<?php echo cdn("img/app/10.0/menu-icon.png"); ?>" /></td>
           <td>Open the menu for additional options</td>
       </tr>
       <tr>
           <td><img src="<?php echo cdn("img/app/10.0/font-size.png"); ?>" /></td>
           <td>Adjust the font size</td>
       </tr>
       <tr>
           <td><img src="<?php echo cdn("img/app/10.0/delete.png"); ?>" /></td>
           <td>Delete all current text</td>
       </tr>
       <tr>
           <td><img src="<?php echo cdn("img/app/10.0/get-started.png"); ?>" /></td>
           <td>Open the initial setup screen</td>
       </tr>
       <tr>
           <td><img src="<?php echo cdn("img/app/10.0/info.png"); ?>" /></td>
...
<ul>
  <li><a href='../13.0/'>Keyman for iPhone and iPad 13.0 Documentation</a></li>
