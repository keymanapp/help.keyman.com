...
function topicresponse_submit()
{
  document.getElementById('topicresponse_iframe').src = 
    ...
    '&email='+encodeURIComponent(document.getElementById('topicresponse_email').value);
  document.getElementById('topicresponse_form').style.display = 'none';
...
"      <a href='javascript:topicresponse_open()'>Send Tavultesoft feedback on this topic</a> | Copyright &#169; 2011 Tavultesoft Pty Ltd. All Rights Reserved."+
"    </div>"+
...
"        Email: <input type='text' name='email' size='40' id='topicresponse_email' /> (optional)<br />"+
