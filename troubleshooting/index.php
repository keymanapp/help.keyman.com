<?php
  ...
  $pagetitle = 'Keyboard Troubleshooting';
  $pagename = 'Keyboard Troubleshooting';
...
<img src="/developer/engine/web/content/troubleshooting/images/boxes.gif" style='float:right; margin: 4px 4px 4px 8px' alt="Boxes Image" />
...
<li>An <a href='/developer/engine/web/2.0/troubleshooting/embedded_fonts.php'>embedded font test page</a> is available for further testing of embedded font support on your computer.</li>
</ul>
...
<img src="/developer/engine/web/content/troubleshooting/images/incorrect-tibetan1.gif" style='float:right; margin: 4px 4px 4px 8px' alt="Tibetan Image" />
...
<p>Some operating systems do not support the correct display of certain scripts.  If you are using Windows, you can fix this issue by <a href="http://tavultesoft/keyman/">downloading and installing Tavultesoft Keyman Desktop</a>.
You can read more about this problem in the <a href='http://tavultesoft/keyman/documentation/70/ref_uniscribe.html'>Keyman Uniscribe Manager Reference</a>.</p>
...
<p>If the <a href='/developer/engine/web/content/ui/osk.php'>On-Screen Keyboard</a> does not appear, or disappears as soon as 
you move it, please check the following:
</p>
<ul>
<li>Make sure KeymanWeb is activated by clicking in the text area.</li>

<li>Confirm that the <a href='/developer/engine/web/content/ui/osk.php'>On-Screen Keyboard</a> is turned on.
In the <b>Button</b> interface, the first item in the Keyboard Menu should be <img src="/developer/engine/web/content/ui/images/ui-bt-hidekb.gif" style='vertical-align: middle' ALT="Hide Keyboard"/>, while in the other user interface designs, the On-Screen Keyboard icon <img src="/developer/engine/web/content/ui/images/ui-tb-control6.gif" height=21 style='vertical-align: middle' ALT="On-Screen Keyboard"/> should have a box around it.</li>
...
<li>For more information on using the On-Screen Keyboard, <a href="/developer/engine/web/content/ui/osk.php">click here</a>.</li>
</ul>
</div>
...
<li>For more information on the KeymanWeb user interfaces, <a href="/developer/engine/web/content/ui/">click here</a>.</li>
</ul>
