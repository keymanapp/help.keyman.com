# HOWTO: Run Debugging in Keyman Desktop and Firefox
...
#### Only follow this if the issue is related to Google products or other web applications.

1) Open a testcase in a tab, e.g. Google Docs or Sheets
