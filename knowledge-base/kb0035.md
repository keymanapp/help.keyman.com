...
`-d` | set the default configuration values for general, startup, OSK, hotkeys and advanced settings. Use this switch to set all the configuration setting to the same as a clean install, resetting the current installed versions configuration.
