...
When the user types, the TSF manager passes key events and text context to Keyman through the ITfContext interface, which provides access to the current edit context within the application. For ITfContext details see [Learn Microsoft](https://learn.microsoft.com/en-us/windows/win32/api/msctf/nn-msctf-itfcontext).
...
The following summarizes the key sequence of operations when a key is pressed in a compliant Windows application.

TODO: Sequence diagram and explanation
