...
obj_spec("Language",
  ...
  "region", "number", "A numerical ID corresponding to the region of the world within which the language is predominantly spoken."
);
?>

<h2>Example case</h2>

  <p>The following is extracted from <a href="https://api.keyman.com/cloud/4.0/languages/heb">
      https://api.keyman.com/cloud/4.0/languages/heb</a>.</p>
