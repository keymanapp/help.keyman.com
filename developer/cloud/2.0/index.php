...
<div class='body_text'>
<h1>KeymanWeb Cloud Services API - version 2.0</h1>

<h3>API usage</h3>

<p>Version 2.0 of the API is a RESTful web service available through HTTP and HTTPS that returns only UTF-8 JSON formatted data.
...
<table class='display grid'>
  ...
  <tbody>
    <tr>
      <td style='white-space: nowrap; vertical-align: top'>GET <a href='https://api.keyman.com/cloud/2.0/languages' target='_blank'>https://api.keyman.com/cloud/2.0/languages</a></td>
      <td>
    ...
    <tr>
      <td style='white-space: nowrap; vertical-align: top'>GET <a href='https://api.keyman.com/cloud/2.0/languages/fra' target='_blank'>https://api.keyman.com/cloud/2.0/languages/<b>fra</b></a></td>
      <td>
        Returns a CloudServices object with a Language object for a language identified by the language code <b>fra</b>.
      </td>
    </tr>
    <tr>
      <td style='white-space: nowrap; vertical-align: top'>GET <a href='https://api.keyman.com/cloud/2.0/keyboards' target='_blank'>https://api.keyman.com/cloud/2.0/keyboards</a></td>
      <td>
    ...
    <tr>
      <td style='white-space: nowrap; vertical-align: top'>GET <a href='https://api.keyman.com/cloud/2.0/keyboards/european' target='_blank'>https://api.keyman.com/cloud/2.0/keyboards/<b>european</b></a></td>
      <td>
    ...
    <tr>
      <td style='white-space: nowrap; vertical-align: top'>GET <a href='https://api.keyman.com/cloud/2.0/keyboards/european/fra' target='_blank'>https://api.keyman.com/cloud/2.0/keyboards/<b>european</b>/<b>fra</b></a></td>
      <td>
...
, "dateformat", "optional", 'Can be <code>"seconds"</code> or <code>"standard"</code>.  If absent, then <code>"standard"</code> is used.'.
  ...
  "version", "optional", 'The version of Keyman Engine, e.g. <code>"10.0"</code>. If absent, uses <code>"9.0"</code>. The server will filter keyboards'.
...
obj_spec(false,
  ...
  "keyboards", "optional", "Array of <a href='obj-keyboard'><code>Keyboard</code></a> objects.",
  "languages", "optional", "Array of <a href='obj-language'><code>Language</code></a> objects.",
  "keyboard", "optional", "<a href='obj-keyboard'><code>Keyboard</code></a> object.",
...
<?= codebox("GET https://api.keyman.com/cloud/2.0/keyboards/european/fra", "http"); ?>
