...
<p class='context-main-image'><img src="<?= cdn('img/developer/100/ui/frmOptions_General.png') ?>" alt="Options dialog - General tab" /></p>
...
<dl>
  ...
  <dd>Keyman Developer 10 will default to saving .kvks files as XML when editing, which makes them easier to share in version control systems such as Git.
...
<p class='context-main-image'><img src="<?= cdn('img/developer/100/ui/frmOptions_Editor.png') ?>" alt="Options dialog - Editor tab" /></p>
...
<p class='context-main-image'><img src="<?= cdn('img/developer/100/ui/frmOptions_Colours.png') ?>" alt="Options dialog - Colours tab" /></p>
...
<p class='context-main-image'><img src="<?= cdn('img/developer/100/ui/frmOptions_Debugger.png') ?>" alt="Options dialog - Debugger tab" /></p>
...
<p class='context-main-image'><img src="<?= cdn('img/developer/100/ui/frmOptions_CharacterMap.png') ?>" alt="Options dialog - Character Map tab" /></p>
