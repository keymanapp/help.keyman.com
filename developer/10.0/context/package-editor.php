...
<p class='context-main-image'><img src="<?= cdn('img/developer/100/ui/frmPackageEditor_Files.png') ?>" alt="Package Editor - Files tab" /></p>
...
<p class='context-main-image'><img src="<?= cdn('img/developer/100/ui/frmPackageEditor_Keyboards.png') ?>" alt="Package Editor - Keyboards tab" /></p>
...
<p><img src="<?= cdn('img/developer/100/ui/frmPackageEditor_Select_BCP_47_Tag.png') ?>" alt="Package Editor - Select BCP 47 Tag dialog" /></p>

<h2 id="details">Details tab</h2>

<p class='context-main-image'><img src="<?= cdn('img/developer/100/ui/frmPackageEditor_Details.png') ?>" alt="Package Editor - Details tab" /></p>
...
<p class='context-main-image'><img src="<?= cdn('img/developer/100/ui/frmPackageEditor_Shortcuts.png') ?>" alt="Package Editor - Shortcuts tab" /></p>
...
<p class='context-main-image'><img src="<?= cdn('img/developer/100/ui/frmPackageEditor_Source.png') ?>" alt="Package Editor - Source tab" /></p>
...
<p class='context-main-image'><img src="<?= cdn('img/developer/100/ui/frmPackageEditor_Build.png') ?>" alt="Package Editor - Compile tab" /></p>
