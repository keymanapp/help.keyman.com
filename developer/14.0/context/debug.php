...
<p class='context-main-image'><img width = 100% src="<?= cdn('img/developer/100/ui/frmKeymanWizard_Debug_State.png') ?>" alt="Debug window - Debug State" /></p>
...
<p class='context-main-image'><img src="<?= cdn('img/developer/100/ui/frmDebug.png') ?>" alt="Debug window - Debug State" /></p>
...
<p class='context-main-image'><img src="<?= cdn('img/developer/100/ui/Debug_Toolbar.png') ?>" alt="Debug toolbar" /></p>

<p class='context-main-image'><img src="<?= cdn('img/developer/100/ui/Debug_Menu.png') ?>" alt="Debug menu" /></p>
...
<p class='context-main-image'><img width=100% src="<?= cdn('img/developer/100/ui/frmKeymanWizard_Debug_Elements.png') ?>" alt="Debug window - Debug Elements" /></p>
...
<p class='context-main-image'><img width=100% src="<?= cdn('img/developer/100/ui/frmKeymanWizard_Debug_CallStack.png') ?>" alt="Debug window - Debug Call stack" /></p>
...
<p class='context-main-image'><img width=100% src="<?= cdn('img/developer/100/ui/frmKeymanWizard_Debug_Deadkeys.png') ?>" alt="Debug window - Debug Deadkeys" /></p>
...
<p class='context-main-image'><img width=100% src="<?= cdn('img/developer/100/ui/frmKeymanWizard_Debug_RegressionTest.png') ?>" alt="Debug window - Debug Regression Test" /></p>
