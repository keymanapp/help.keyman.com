...
>[!NOTE]
> The older header keywords are deprecated and will be not be supported for keyboards that target Keyman 20.0 or later. [System stores](stores#toc-system-stores) should be used in place of header keywords.
