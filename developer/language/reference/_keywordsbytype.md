...
> [!NOTE]
> The older header statements are deprecated and will not be supported for keyboards that target Keyman 20.0 or later. [system stores](../guide/stores#toc-system-stores) should be used in place of header keywords.
