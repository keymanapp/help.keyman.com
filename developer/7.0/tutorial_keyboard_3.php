...
c Simplified French Keyboard for Keyman 7.0
  ...
  </p><h4><a name="id622386"></a>The &amp;Version system store</h4><pre class="programlisting">
store(&amp;Version) "7.0"             c This keyboard is for use with Keyman 7.0
    ...
    store in the file.
  </p><h4><a name="id622402"></a>The &amp;Name system store</h4><pre class="programlisting">
store(&amp;Name)    "Quick French"
  ...
  </p><h4><a name="id622417"></a>The &amp;Bitmap system store</h4><pre class="programlisting">
store(&amp;Bitmap)  "qfrench.ico"
    ...
    <span class="inlinemediaobject"><img src="images/tutorial_keyboard_qfrench.gif"></span>
  ...
  </p><h4><a name="id622448"></a>The &amp;MnemonicLayout system store</h4><pre class="programlisting">
store(&amp;MnemonicLayout) "1"
  ...
  </p><h4><a name="id622464"></a>The begin statement</h4><pre class="programlisting">
