<?php  require_once('includes/template.php');    head([    'title' => 'Keyman Support | Type to the world in your language',    'css' => ['template.css','keyboard.css','keys.css','Kmhelp.css']  ]);?><body bgcolor="white" text="black" link="#0000FF" vlink="#840084" alink="#0000FF"><div class="navheader"><table width="100%" summary="Navigation header"><tr><th colspan="3" align="center">Programmer's Guide - Stores</th></tr><tr><td width="20%" align="left"><a accesskey="p" href="guide_lang_rules.php">Prev</a> </td><th width="60%" align="center">Keyman Keyboard Language Guide</th><td width="20%" align="right"> <a accesskey="n" href="guide_lang_vkeys.php">Next</a></td></tr></table><hr></div><div class="section" lang="en"><div class="titlepage"><div><div><h3 class="title"><a name="guide_lang_stores"></a>Programmer's Guide - Stores</h3></div></div></div><p>
      ...
      </p><h4><a name="id754325"></a>Creating Stores</h4><p>
...
store( %storename% ) %storecontents%
      ...
      </p><h4><a name="id754158"></a>Using Stores</h4><p>
...
any(vowel) + '^' &gt; index(vowel_circum, 1)
  ...
  </p><h4><a name="id754980"></a>Outputting Stores</h4><p>
