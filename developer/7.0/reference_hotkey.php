...
HOTKEY "%tsHotKey%"
      ...
      </p><h5><a name="id706888"></a>Example</h5><pre class="programlisting">
store( &amp;hotkey ) "^+A"                   c Ctrl+Shift+A
store( &amp;hotkey ) "[Alt Shift K_PAUSE]"   c Alt+Shift+Pause
      </pre><h5><a name="id706963"></a>Versions</h5><p>The virtual key hotkey functionality was introduced in Keyman 3.1.</p><h5><a name="id707250"></a>Related Topics</h5><div class="itemizedlist"><ul type="disc"><li><p><a class="xref" href="reference__struct_headers.php" title="Header keywords">Header keywords</a></p></li><li><p><a class="xref" href="reference__struct_vkeys.php" title="Virtual Keys and Virtual Character Keys">Virtual Keys and Virtual Character Keys</a></p></li></ul></div></div><div class="navfooter"><hr><table width="100%" summary="Navigation footer"><tr><td width="40%" align="left"><a accesskey="p" href="reference_ethnologuecode.php">Prev</a> </td><td width="20%" align="center"><a accesskey="u" href="reference_systemstores_index.php">Up</a></td><td width="40%" align="right"> <a accesskey="n" href="reference_includecodes.php">Next</a></td></tr><tr><td width="40%" align="left" valign="top">EthnologueCode system store </td><td width="20%" align="center"><a accesskey="h" href="index.php">Home</a></td><td width="40%" align="right" valign="top"> includecodes system store</td></tr></table></div>
