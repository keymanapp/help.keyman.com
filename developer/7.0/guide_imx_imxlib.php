...
BOOL PrepIM(void);
      ...
      </p><h4><a name="id708874"></a>IMDefWindowProc</h4><p>
    </p><pre class="programlisting">
BOOL IMDefWindowProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam, LRESULT *lResult);
        ...
        and movement.
      </p><h4><a name="id708784"></a>Keyman Imports</h4><p>
      ...
      </p><h4><a name="id708749"></a>KMGetContext</h4><p>
    </p><pre class="programlisting">
BOOL WINAPI KMGetContext(PWSTR buf, DWORD len);
      </pre><p>
  </p><p>
        KMGetContext returns the last len-1 characters of the context stack.  If there are not enough
...
UC_SENTINEL, CODE_DEADKEY, deadkeyID
      ...
      </p><h4><a name="id708795"></a>KMSetOutput</h4><p>
    </p><pre class="programlisting">
...
while(*buf) KMQueueAction(QIT_CHAR, *buf++); 
  ...
  </p><h4><a name="id708769"></a>KMQueueAction</h4><p>
    </p><pre class="programlisting">
BOOL WINAPI KMQueueAction(int itemType, DWORD dwData); 
      ...
      <td>QIT_BACK</td>
      <td>dwData should be zero (0).</td>
    </tr></tbody></table><h4><a name="id708774"></a>KMHideIM</h4><p>
    </p><pre class="programlisting">
BOOL WINAPI KMHideIM(HWND hwndIM); 
      ...
      </p><h4><a name="id708684"></a>KMDisplayIM</h4><p>
    </p><pre class="programlisting">
BOOL WINAPI KMDisplayIM(HWND hwndIM, BOOL FCaptureAll); 
      ...
      </p><h4><a name="id708593"></a>KMGetKeyboardPath</h4><p>
    </p><pre class="programlisting">
BOOL WINAPI KMGetKeyboardPath(PSTR keyboardname, PWSTR dir, DWORD length); 
      ...
      </p><h4><a name="id708520"></a>KMGetActiveKeyboard</h4><p>
    </p><pre class="programlisting">
BOOL WINAPI KMGetActiveKeyboard(PSTR keyboardname, DWORD length);
      ...
      </p><h4><a name="id708425"></a>KMSendDebugString</h4><p>
    </p><pre class="programlisting">
BOOL WINAPI KMSendDebugString(PSTR str);
      ...
      </p><h4><a name="id708354"></a>The Input Method Composition window</h4><p>
...
PostMessage(hwnd, wm_keymanim_close, (WPARAM) FSuccess, (LPARAM) FActuallyClose);
      ...
      </p><h4><a name="id708181"></a>Limitations</h4><p>
