<?php  require_once('includes/template.php');    head([    'title' => 'Keyman Support | Type to the world in your language',    'css' => ['template.css','keyboard.css','keys.css','Kmhelp.css']  ]);?><body bgcolor="white" text="black" link="#0000FF" vlink="#840084" alink="#0000FF"><div class="navheader"><table width="100%" summary="Navigation header"><tr><th colspan="3" align="center">Manual Control Example</th></tr><tr><td width="20%" align="left"><a accesskey="p" href="guide_kmw_automatic_control_loaded.php">Prev</a> </td><th width="60%" align="center">KeymanWeb Guide</th><td width="20%" align="right"> <a accesskey="n" href="guide_kmw_full_manual_control.php">Next</a></td></tr></table><hr></div><div class="section" lang="en"><div class="titlepage"><div><div><h3 class="title"><a name="guide_kmw_manual_control"></a>Manual Control Example</h3></div></div></div><p>
  ...
  </p><p>A working example can be seen online at <a class="ulink" href="http://www.keymanweb.com/dev/manual_control.php" target="_blank">www.keymanweb.com</a></p><span class="inlinemediaobject"><img src="images/kmw_manual_control.png"></span><h4><a name="id755011"></a>Code Walkthrough</h4><p>Include the following script in the HEAD of your page:</p><pre class="programlisting">
