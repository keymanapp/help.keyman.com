<?php  require_once('includes/template.php');    head([    'title' => 'Keyman Support | Type to the world in your language',    'css' => ['template.css','keyboard.css','keys.css','Kmhelp.css']  ]);?><body bgcolor="white" text="black" link="#0000FF" vlink="#840084" alink="#0000FF"><div class="navheader"><table width="100%" summary="Navigation header"><tr><th colspan="3" align="center">downloadkeyboard.xsl: Download Keyboard Dialog</th></tr><tr><td width="20%" align="left"><a accesskey="p" href="reference_branding_activate.php">Prev</a> </td><th width="60%" align="center">Reference - Branding Toolkit for Keyman Developer Professional</th><td width="20%" align="right"> <a accesskey="n" href="reference_branding_elements.php">Next</a></td></tr></table><hr></div><div class="section" lang="en"><div class="titlepage"><div><div><h3 class="title"><a name="reference_branding_downloadkeyboard"></a>downloadkeyboard.xsl: Download Keyboard Dialog</h3></div></div></div><p>
  ...
  </p><h4><a name="id543880"></a>XML Parameters</h4><h4><a name="id543884"></a>Targets</h4><table id="id543888"><tr>
      <th>Target</th>
      <th>Parameters</th>
      <th>Description</th>
    </tr><tr>
