<?php  require_once('includes/template.php');    head([    'title' => 'Keyman Support | Type to the world in your language',    'css' => ['template.css','keyboard.css','keys.css','Kmhelp.css']  ]);?><body bgcolor="white" text="black" link="#0000FF" vlink="#840084" alink="#0000FF"><div class="navheader"><table width="100%" summary="Navigation header"><tr><th colspan="3" align="center">User Interface Modes</th></tr><tr><td width="20%" align="left"><a accesskey="p" href="reference_kmw__css.php">Prev</a> </td><th width="60%" align="center">KeymanWeb</th><td width="20%" align="right"> <a accesskey="n" href="reference_kmw__variables.php">Next</a></td></tr></table><hr></div><div class="section" lang="en"><div class="titlepage"><div><div><h3 class="title"><a name="reference_kmw__uimodes"></a>User Interface Modes</h3></div></div></div><p>
    ...
    yourself, as shown in the <a class="link" href="guide_kmw_full_manual_control.php" title="Full Manual Control Example">Full Manual Control example</a>.
  </p><h4><a name="id762322"></a>Related Topics</h4><div class="itemizedlist"><ul type="disc"><li><a class="xref" href="reference_kmw_SetMode.php" title="Function: SetMode">Function: SetMode</a></li><li><a class="xref" href="reference_kmw_GetMode.php" title="Function: GetMode">Function: GetMode</a></li><li><a class="xref" href="reference_kmw_ShowInterface.php" title="Function: ShowInterface">Function: ShowInterface</a></li><li><a class="xref" href="reference_kmw_HideInterface.php" title="Function: HideInterface">Function: HideInterface</a></li><li><a class="xref" href="reference_kmw_ShowHelp.php" title="Function: ShowHelp">Function: ShowHelp</a></li><li><a class="xref" href="reference_kmw_HideHelp.php" title="Function: HideHelp">Function: HideHelp</a></li></ul></div></div><div class="navfooter"><hr><table width="100%" summary="Navigation footer"><tr><td width="40%" align="left"><a accesskey="p" href="reference_kmw__css.php">Prev</a> </td><td width="20%" align="center"><a accesskey="u" href="reference_kmw_index.php">Up</a></td><td width="40%" align="right"> <a accesskey="n" href="reference_kmw__variables.php">Next</a></td></tr><tr><td width="40%" align="left" valign="top">CSS classes for Visual Keyboard </td><td width="20%" align="center"><a accesskey="h" href="index.php">Home</a></td><td width="40%" align="right" valign="top"> Global Variables</td></tr></table></div>
