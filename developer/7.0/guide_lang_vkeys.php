<?php  require_once('includes/template.php');    head([    'title' => 'Keyman Support | Type to the world in your language',    'css' => ['template.css','keyboard.css','keys.css','Kmhelp.css']  ]);?><body bgcolor="white" text="black" link="#0000FF" vlink="#840084" alink="#0000FF"><div class="navheader"><table width="100%" summary="Navigation header"><tr><th colspan="3" align="center">Programmer's Guide - Virtual Keys</th></tr><tr><td width="20%" align="left"><a accesskey="p" href="guide_lang_stores.php">Prev</a> </td><th width="60%" align="center">Keyman Keyboard Language Guide</th><td width="20%" align="right"> <a accesskey="n" href="index_guide_kmw.php">Next</a></td></tr></table><hr></div><div class="section" lang="en"><div class="titlepage"><div><div><h3 class="title"><a name="guide_lang_vkeys"></a>Programmer's Guide - Virtual Keys</h3></div></div></div><p>
      ...
      </p><h4><a name="id755080"></a>Using Virtual Keys</h4><p>
...
+ [CTRL ALT K_A] &gt; "You pressed Ctrl+Alt+A"
      ...
      <td>Caps Lock off </td>
      <td>NCAPS </td>
    </tr></tbody></table><h4><a name="id755220"></a>AltGr and Other Special Keys</h4><p>
...
+ [RALT K_A] &gt; "You pressed AltGr+A"
      ...
      </p><h4><a name="id755245"></a>Virtual Keys in Output</h4><p>
      ...
      </p><h4><a name="id755252"></a>Related Topics</h4><div class="itemizedlist"><ul type="disc"><li><p><a class="xref" href="reference__struct_vkeys.php" title="Virtual Keys and Virtual Character Keys">Virtual Keys and Virtual Character Keys</a></p></li></ul></div></div><div class="navfooter"><hr><table width="100%" summary="Navigation footer"><tr><td width="40%" align="left"><a accesskey="p" href="guide_lang_stores.php">Prev</a> </td><td width="20%" align="center"><a accesskey="u" href="index_guide_language.php">Up</a></td><td width="40%" align="right"> <a accesskey="n" href="index_guide_kmw.php">Next</a></td></tr><tr><td width="40%" align="left" valign="top">Programmer's Guide - Stores </td><td width="20%" align="center"><a accesskey="h" href="index.php">Home</a></td><td width="40%" align="right" valign="top"> KeymanWeb Guide</td></tr></table></div>
