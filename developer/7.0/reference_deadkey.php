...
dk(%name%)
      ...
      </p><h5><a name="id736775"></a>Example</h5><pre class="programlisting">
+ '`' &gt; dk(backquote)
dk(backquote) + 'e' &gt; 'è'
      </pre><p>
...
dk()* any(char) dk()* + [K_BKSP] &gt; nul
      </pre><h5><a name="id735523"></a>Versions</h5><p>Numbered deadkeys were introduced in version 3.0. Keyman 5.0 and later support
