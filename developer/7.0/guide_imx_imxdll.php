<?php  require_once('includes/template.php');    head([    'title' => 'Keyman Support | Type to the world in your language',    'css' => ['template.css','keyboard.css','keys.css','Kmhelp.css']  ]);?><body bgcolor="white" text="black" link="#0000FF" vlink="#840084" alink="#0000FF"><div class="navheader"><table width="100%" summary="Navigation header"><tr><th colspan="3" align="center">DLL Exports</th></tr><tr><td width="20%" align="left"><a accesskey="p" href="index_guide_imx.php">Prev</a> </td><th width="60%" align="center">IMX Developers Guide</th><td width="20%" align="right"> <a accesskey="n" href="guide_imx.php">Next</a></td></tr></table><hr></div><div class="section" lang="en"><div class="titlepage"><div><div><h3 class="title"><a name="guide_imx_imxdll"></a>DLL Exports</h3></div></div></div><p>
  ...
  </p><h4><a name="id755804"></a>DLL group function exports</h4><p>
...
BOOL WINAPI KeyEvent(HWND hwndFocus, WORD KeyStroke, WCHAR KeyChar, DWORD ShiftFlags);
    ...
    have multiple exports for Keyman use in a single DLL.
        ...
        </td></tr></tbody></table></div><h4><a name="id756083"></a>Optional DLL Exports</h4><p>
      ...
      </p><h4><a name="id756094"></a>KeymanIMInit</h4><p>
    </p><pre class="programlisting">
BOOL WINAPI KeymanIMInit(PSTR keyboardname);
        ...
        keyboard is loaded.
      </p><h4><a name="id756108"></a>KeymanIMDestroy</h4><p>
    </p><pre class="programlisting">
BOOL WINAPI KeymanIMDestroy(PSTR keyboardname);
      ...
      </p><h4><a name="id708756"></a>KeymanIMActivate</h4><p>
    </p><pre class="programlisting">
BOOL WINAPI KeymanIMActivate(PSTR keyboardname);
      ...
      </p><h4><a name="id708358"></a>KeymanIMDeactivate</h4><p>
    </p><pre class="programlisting">
BOOL WINAPI KeymanIMDeactivate(PSTR keyboardname);
      ...
      </p><h4><a name="id708043"></a>KeymanIMConfigure</h4><p>
    </p><pre class="programlisting">
