...
store(%snStore%) %xsData%
      ...
      </p><h5><a name="id735623"></a>Example</h5><pre class="programlisting">
store(keys) "ABCDEFG"
      </pre><h5><a name="id735198"></a>Versions</h5><p>The return statement was introduced in Keyman 3.0. Starting in version 6.0,
      deadkeys and virtual keys are allowed within stores.  Version 5.0
      and earlier did not allow these.
    </p><h5><a name="id735373"></a>Related Topics</h5><div class="itemizedlist"><ul type="disc"><li><p><a class="xref" href="reference_index.php" title="index statement">index statement</a></p></li><li><p><a class="xref" href="reference__struct_stores.php" title="Using Stores">Using Stores</a></p></li></ul></div></div><div class="navfooter"><hr><table width="100%" summary="Navigation footer"><tr><td width="40%" align="left"><a accesskey="p" href="reference_return.php">Prev</a> </td><td width="20%" align="center"><a accesskey="u" href="reference_statements_index.php">Up</a></td><td width="40%" align="right"> <a accesskey="n" href="reference_use.php">Next</a></td></tr><tr><td width="40%" align="left" valign="top">return statement </td><td width="20%" align="center"><a accesskey="h" href="index.php">Home</a></td><td width="40%" align="right" valign="top"> use statement</td></tr></table></div>
