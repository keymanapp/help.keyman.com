<?php  require_once('includes/template.php');    head([    'title' => 'Keyman Support | Type to the world in your language',    'css' => ['template.css','keyboard.css','keys.css','Kmhelp.css']  ]);?><body bgcolor="white" text="black" link="#0000FF" vlink="#840084" alink="#0000FF"><div class="navheader"><table width="100%" summary="Navigation header"><tr><th colspan="3" align="center">Step 2: Choosing a user interface model</th></tr><tr><td width="20%" align="left"><a accesskey="p" href="tutorial_branding_1.php">Prev</a> </td><th width="60%" align="center">Branding Tutorial</th><td width="20%" align="right"> <a accesskey="n" href="tutorial_branding_3.php">Next</a></td></tr></table><hr></div><div class="section" lang="en"><div class="titlepage"><div><div><h3 class="title"><a name="tutorial_branding_2"></a>Step 2: Choosing a user interface model</h3></div></div></div><p>In the Branding Editor, click the <span class="guibutton">Details</span> tab.</p><p>
  ...
  </p><h4><a name="id744763"></a>Keyman Desktop User Interface</h4><p>
    ...
    You will find the <a class="link" href="ref_locale.php" title="Translating the Keyman Desktop User Interface">Localization of Keyman Desktop</a> topic helpful for understanding
    how to localize your product.
  </p><h4><a name="id744791"></a>Your own User Interface</h4><p>
