<?php  require_once('includes/template.php');    head([    'title' => 'Keyman Support | Type to the world in your language',    'css' => ['template.css','keyboard.css','keys.css','Kmhelp.css']  ]);?><body bgcolor="white" text="black" link="#0000FF" vlink="#840084" alink="#0000FF"><div class="navheader"><table width="100%" summary="Navigation header"><tr><th colspan="3" align="center">Step 2: Creating Additional Files for the Package</th></tr><tr><td width="20%" align="left"><a accesskey="p" href="tutorial_package_1.php">Prev</a> </td><th width="60%" align="center">Package Tutorial</th><td width="20%" align="right"> <a accesskey="n" href="tutorial_package_3.php">Next</a></td></tr></table><hr></div><div class="section" lang="en"><div class="titlepage"><div><div><h3 class="title"><a name="tutorial_package_2"></a>Step 2: Creating Additional Files for the Package</h3></div></div></div><p>
    ...
    that you would create for a package.
      ...
      tedious, so make sure that your users don't have to locate and install fonts themselves!</p><p>
        ...
        format is available <a class="link" href="ref_locale.php" title="Translating the Keyman Desktop User Interface">here</a>.
      </p></li></ol></div><p>
