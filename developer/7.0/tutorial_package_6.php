<?php  require_once('includes/template.php');    head([    'title' => 'Keyman Support | Type to the world in your language',    'css' => ['template.css','keyboard.css','keys.css','Kmhelp.css']  ]);?><body bgcolor="white" text="black" link="#0000FF" vlink="#840084" alink="#0000FF"><div class="navheader"><table width="100%" summary="Navigation header"><tr><th colspan="3" align="center">Step 6: Compiling, testing and distributing a Package</th></tr><tr><td width="20%" align="left"><a accesskey="p" href="tutorial_package_5.php">Prev</a> </td><th width="60%" align="center">Package Tutorial</th><td width="20%" align="right"> <a accesskey="n" href="tutorial_branding.php">Next</a></td></tr></table><hr></div><div class="section" lang="en"><div class="titlepage"><div><div><h3 class="title"><a name="tutorial_package_6"></a>Step 6: Compiling, testing and distributing a Package</h3></div></div></div><p>
  ...
  </p><h4><a name="id717911"></a>Distributing a package on the Tavultesoft website</h4><p>
  ...
  </p><h4><a name="id717974"></a>Distributing a package on your own website</h4><p>
