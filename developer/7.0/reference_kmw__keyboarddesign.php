<?php  require_once('includes/template.php');    head([    'title' => 'Keyman Support | Type to the world in your language',    'css' => ['template.css','keyboard.css','keys.css','Kmhelp.css']  ]);?><body bgcolor="white" text="black" link="#0000FF" vlink="#840084" alink="#0000FF"><div class="navheader"><table width="100%" summary="Navigation header"><tr><th colspan="3" align="center">Keyboard Design</th></tr><tr><td width="20%" align="left"><a accesskey="p" href="reference_kmw_KeyboardInfo.php">Prev</a> </td><th width="60%" align="center">KeymanWeb</th><td width="20%" align="right"> <a accesskey="n" href="reference_kmw__css.php">Next</a></td></tr></table><hr></div><div class="section" lang="en"><div class="titlepage"><div><div><h3 class="title"><a name="reference_kmw__keyboarddesign"></a>Keyboard Design</h3></div></div></div><p>
    ...
    information that you can pass to the compiler and some recommendations.
  </p><h4><a name="id763932"></a>Additional System Stores</h4><div class="itemizedlist"><ul type="disc"><li><p><code class="code">&amp;VisualKeyboard:</code> Use a store with this name to
      ...
      Reference a .php fragment to embed below the visual keyboard,
      ...
      extending keyboard functionality.</p></li></ul></div><h4><a name="id763543"></a>Recommendatations</h4><div class="itemizedlist"><ul type="disc"><li><p>Only Unicode keyboards are supported.</p></li><li><p>Avoid using virtual keys where possible, as some platforms do not support
