<?php
  ...
  head([
    'title' => "CSS classes for Visual Keyboard"
  ]);
?>
<div class="navheader"><table width="100%" summary="Navigation header"><tr><th colspan="3" align="center">CSS classes for Visual Keyboard</th></tr><tr><td width="20%" align="left"><a accesskey="p" href="reference_kmw__keyboarddesign.php">Prev</a> </td><th width="60%" align="center">KeymanWeb 1.0</th><td width="20%" align="right"> <a accesskey="n" href="reference_kmw__uimodes.php">Next</a></td></tr></table><hr></div><div class="section" lang="en"><div class="titlepage"><div><div><h3 class="title" id="reference_kmw__css">CSS classes for Visual Keyboard</h3></div></div></div><p>
