...
<?php
  ...
  head([
    'title' => "Keyman Engine for Web 15.0 Developer Help"
  ]);
?>

<h1 class="title" id="">Keyman Engine for Web 15.0 Developer Help</h1>

<div class='body_text'>

<p style='margin-top: 16px'>
<p>Keyman Engine for Web 15.0 is the current version of KeymanWeb and supports touch devices with custom touch-layouts as well as desktop computer browsers.</p>

  <dl>
    <dt><a href='https://keyman.com/developer/keymanweb/'>Download</a></dt>
    <dd>Downloading Keyman Engine for Web 15.0</dd>
  </dl>

  <dl>
  <dt><a href='guide/'>Guide</a></dt>
  <dd>Keyman Engine for Web 15.0 Guide</dd>
  </dl>
