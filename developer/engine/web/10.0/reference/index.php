<?php
  ...
  head([
    'title' => "KeymanWeb 10.0"
  ]);

  require_once("includes/__docheader.php");
?>

<h1 class="title" id="">KeymanWeb 10.0 Reference</h1>

  <dl>
  <dt><a href='overview'>KeymanWeb 10.0 Overview</a></dt>
  ...
  <dl>
  <dt><a href='core/init#init_options'>KeymanWeb 10.0 Initialization Options</a></dt>
  <dd>The following options can be defined by the site designer in the initialization call to KeymanWeb.</dd>
  </dl>

  <dl>
  <dt><a href='events'>KeymanWeb 10.0 Events</a></dt>
  ...
  <dl>
  <dt><a href='keyboard_properties'>KeymanWeb 10.0 Keyboard Properties</a></dt>
  ...
  <dl>
  <dt><a href='layouts'>KeymanWeb 10.0 Layout Designer</a></dt>
  <dd>One of the main features of KeymanWeb 10 is its ability to support distinct, user-customizable layouts for
    touch-screen keyboards on phones and tablets.</dd>
  </dl> 

  <dl>
  <dt><a href='layoutspec'>KeymanWeb 10.0 Layout Specifications</a></dt>
  <dd>Touch-screen layouts for KeymanWeb 10 are specified as JSON objects containing a member object for each specified device type.</dd>
  </dl> 
