...
<?php
  ...
  head([
    'title' => "Keyman Engine for Web 12.0 - The Guide"
  ]);
?>

<h1 class="title" id="">KeymanWeb 12.0 - The Guide</h1>
<p style='margin-top: 16px'>

<div class='body_text'>

<p>Welcome to the guide for using KeymanWeb 12.0.</p>
...
<a href='../'>Return to the main KeymanWeb 12.0 page</a>
