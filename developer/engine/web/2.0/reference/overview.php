...
<dl>
  <dt><em>Core</em></dt>
  <dd>Exposed as <a href="core"><code><?="$kmw"?></code></a>.</dd>
  <dt><em>On-Screen Keyboard</em></dt>
  <dd>Exposed as <a href="osk"><code><?="$kmw.osk"?></code></a>.</dd>
  <dt><em>Utility Functions</em></dt>
  <dd>Exposed as <a href="util"><code><?="$kmw.util"?></code></a>.</dd>
  <dt><em>User Interface</em></dt>
  <dd>Exposed as <a href="ui"><code><?="$kmw.ui"?></code></a>.</dd>
</dl>
</div>