...
<p>See <a href="getKeyboard.php"><?="$kmw.getKeyboard()"?></a> for detail on the returned keyboard specification objects.</p>
<p>See also <a href="addKeyboards.php"><?="$kmw.addKeyboards()"?></a>.</p>