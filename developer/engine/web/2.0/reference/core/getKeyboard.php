...
<?php
syntax("$kmw.getKeyboard(keyboardName, languageCode)");
params("keyboardName", "string", "The ID (internal name) of the keyboard.",
  "languageCode", "optional string", "The 3-letter language code, according to ISO 639-3.");
...
<p>See also <a href="addKeyboards.php"><?="$kmw.addKeyboards()"?></a> and its documentation about keyboard specification
  objects.</p>