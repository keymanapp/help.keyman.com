...
syntax("$kmw.addKeyboards(spec[, spec...])");
...
<p>
  For general information and example uses of this method, please see the <a href="../../guide/adding-keyboards.php">Adding Keyboards</a> page from the guide section.
</p>
...
<div class="itemizedlist"><ul type="disc">
	...
	<li><code class="code">'@languageID'</code>: Adds the default keyboard for the specified ISO 639-3 language code</li>
...
obj_spec("spec",
  ...
  "language", "required array|object", "An array of objects (see definition below) or single object linked to the keyboard.",
