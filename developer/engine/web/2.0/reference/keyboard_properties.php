<?php
  ...
  head([
    'title' => "KeymanWeb 2.0 Keyboard Properties"
  ]);
?>
...
<p>
    ...
    <tr><td align="left"><span class="emphasis"><em>KLC</em></span></td><td align="left">languageCode</td><td align="left">Keyboard (optional) or stub script</td><td align="left">Standard ISO code(s) for supported keyboard language(s)</td></tr>
