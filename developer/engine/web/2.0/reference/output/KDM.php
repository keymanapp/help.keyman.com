...
<h1 class="title" id="KDM">KDM</h1>

<h2 id="Summary" name="Summary">Summary</h2>

<p>Deadkey matching:  Seeks to match the <a href="/developer/language/reference/deadkey"><code class="language-keyman">deadkey</code></a>
  state <code>dk</code> at the relative caret position <code>n</code>.</p>

<?php
syntax("KeymanWeb.KDM(n, Pelem, dk);");
