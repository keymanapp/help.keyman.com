...
<h1 class="title" id="KA">KA</h1>

<h2 id="Summary" name="Summary">Summary</h2>

<p>Returns whether or not the char <code>ch</code> is found within the <a href="/developer/language/reference/any">
...
<?php
syntax("KeymanWeb.KA(index, ch, any);");
params("index", "number", "The index id (starting from zero) at which the detected character will be internally tracked.",
  ...
  "any", "string", "The contents of the specified text <code class='language-keyman'>store</code>.");
...
<code>KeymanWeb.KA()</code>'s role in this process is usually optimized out into individual mappings for performance reasons,
...
above, the code </p>
<?=codebox("KeymanWeb.KA(0, 'a', 'abcde')")?>
<p>would suffice, setting an internally-tracked index (id=0) to hold the index value 0.   Note that the internally-tracked
  ...
  the keyboard source above; the corresponding <a href="KIO"><code>KeymanWeb.KIO()</code></a> call increments the id by
  1 due to Keyman's keyboard language rules.</p>

<h2>See also</h2>

<p><a href="KIO"><code>KeymanWeb.KIO()</code></a></p>
