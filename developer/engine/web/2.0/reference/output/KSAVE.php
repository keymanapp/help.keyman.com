<?php
  ...
  head([
    'title' => "Function: KSAVE"
  ]);

  require_once('includes/__docheader.php');
?>

<h1 class="title" id="KSAVE">KSAVE</h1>
...
<?php
syntax("KeymanWeb.KSAVE(storeName, value);");
...
<p><a href="KLOAD"><code>KeymanWeb.KLOAD()</code></a> and <code>KeymanWeb.KSAVE()</code>provide API-based functionality
...
<p><a href="KLOAD"><code>KeymanWeb.KLOAD();</code></a></p>