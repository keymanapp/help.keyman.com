...
head([
  'title' => "KeymanWeb 2.0 - Installing Languages"
]);
?>
...
<p>In the examples that follow, please note the use of variable <code>kmw</code> as shorthand for the <code>tavultesoft.keymanweb</code> object.</p>
...
kmw.addKeyboards({
    ...
    language:{
      id:'eng',               // A three-letter code uniquely identifying the language.
                              // Please refer to the <a href="https://en.wikipedia.org/wiki/ISO_639">ISO-639 standard</a> as necessary.
...
<pre><code>font:{family:'LaoWeb',source:['../font/saysettha_web.ttf','../font/saysettha_web.woff','../font/saysettha_web.eot']}</code></pre>
...
<p>Alternatively, languages may be looked up via their ISO 639 language code as follows:</p>

<pre><code>kmw.addKeyboards('@heb')</code></pre>

<p>The <code>@</code> prefix indicates the use of the ISO 639 language code, which in this case corresponds with Hebrew.</p>
...
<pre><code>kmw.addKeyboards('french','european2@swe','european2@nor')</code></pre>
