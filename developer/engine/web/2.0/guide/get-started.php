...
<h2>Demo</h2>
<p>To setup a basic first page with KeymanWeb, only two lines of code are necessary, but a few more lines will be shown here.  Toward that end, <a href="examples/first-example.html">an example page</a>:</p>

<?php embed_with_iframe("examples/first-example.html", 250); ?>
...
<head>
  <meta charset="UTF-8">
  <title>KeymanWeb 2.0 - A First Example</title>

  <script src='https://s.keyman.com/kmw/engine/426/keymanweb.js'></script>
  <script src='https://s.keyman.com/kmw/engine/426/kmwuitoggle.js'></script>
  <script>
      (function(kmw) {
...
<p>On initialization:  <a href="../reference/core/init"><code><?="$kmw.init()"?></code></a>.</p>
<p>On including keyboards:  <a href="../reference/core/addKeyboards"><code><?="$kmw.addKeyboards()"?></code></a>.</p>