...
<?php
syntax("keyman.util.getAbsolute(Pelem);");
...
<p>See also:  <a href="getAbsoluteX"><code>keyman.util.getAbsoluteX()</code></a>,
  <a href="getAbsoluteY"><code>keyman.util.getAbsoluteY()</code></a>
</p>