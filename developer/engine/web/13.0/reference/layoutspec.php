<?php
  ...
  head([
    'title' => "KeymanWeb 13.0 Layout Specifications"
  ]);
?>
...
<p>
    ...
    Details of key member specifications are given below:
        ...
        Keys identified as <span class="emphasis"><em>U_xxxx</em></span> specify a Unicode character
        in hex format, e.g. <span class="emphasis"><em>U_1363</em></span> for the Ethiopic Comma character, 
        and will insert that character if not matched by a rule.  Other user-defined keys, such as 
