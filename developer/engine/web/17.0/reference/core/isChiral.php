...
<a href="../events/keyman/keyboardloaded"><code language="none">keyboardloaded</code></a> event completes and after the
<a href="../events/keyman/keyboardchange"><code language="none">keyboardchange</code></a> event has completed for the
first activation of a keyboard.  However, both events return the name of the keyboard involved in the event, and this can
be passed as an argument to <code>isChiral</code> from the <a href="../events/keyman/keyboardloaded"><code language="none">keyboardloaded</code></a>
