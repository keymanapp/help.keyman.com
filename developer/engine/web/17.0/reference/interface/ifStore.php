<?php
  ...
  head([
    'title' => "Function: ifStore"
  ]);

  require_once('includes/__docheader.php');
?>

<h1 class="title" id="KIFS">ifStore (KIFS)</h1>

<h2 id="Summary" name="Summary">Summary</h2>

<p><code>ifStore</code> compares the content of a <a href="/developer/language/guide/stores#toc-system-stores">system
    <code class="language-keyman">store</code></a> with a string value.</p>

<?php
syntax("keyman.interface.ifStore(systemId, strValue, Pelem);", "KeymanWeb.KIFS(systemId, strValue, Pelem);");
...
<p><a href="setStore"><code>keyman.interface.setStore()</code></a></p>