<?php
  ...
  head([
    'title' => "Function: loadStore"
  ]);

  require_once('includes/__docheader.php');
?>

<h1 class="title" id="KLOAD">loadStore (KLOAD)</h1>
...
<?php
syntax("keyman.interface.loadStore(kbdName, storeName, value);", "KeymanWeb.KLOAD(kbdName, storeName, value); // Shorthand");
...
<p><code>keyman.interface.loadStore()</code> and <a href="saveStore"><code>keyman.interface.saveStore()</code></a> provide API-based functionality
...
<p><a href="saveStore"><code>keyman.interface.saveStore();</code></a></p>