...
<ol>
    <li>Install <a href="https://keyman.com/developer/">Keyman Developer 9 or later</a>.</li>
...
<ol>
    <li>Keyman 9+ users can download the engine from downloads.keyman.com
...
<ul>
    <li><a href="../../../../../9.0/guides/develop/creating-a-touch-keyboard-layout-for-amharic-with-keyman-developer-9">
        Creating a Touch Keyboard Layout for Amharic with Keyman Developer 9</a></li>
    <li><a href="../../../../../9.0/guides/develop/creating-a-touch-keyboard-layout-for-amharic-the-nitty-gritty">
        Creating A Touch Keyboard Layout For Amharic — The Nitty Gritty</a></li>
    <li><a href="../../../../../9.0/guides/test/how-to-test-your-keyboard-layout-with-keyman-developer-9-touch-and-desktop">
        How to test your keyboard layout with Keyman Developer 9 — touch and desktop</a></li>
    <li><a href="../../../../../9.0/guides/test/how-to-test-your-touch-layout-in-the-google-chrome-mobile-emulator">
...
<p><a class="asset-img-link" style="display: inline;"
      href="<?php echo cdn("img/engine/android/2.0/guides/in-app/touch-layout.png"); ?>"><img
      class="asset asset-image at-xid-6a00d83432368053ef01b7c759d462970b image-full img-responsive"
      title="Keyman-developer"
      src="<?php echo cdn("img/engine/android/2.0/guides/in-app/touch-layout-800wi.png"); ?>"
...
<p>Open the containing folder for the keyboard to find the Javascript file to copy over; its name will be based on
    your source keyboard name, plus an appended version number.</p>
<p><a class="asset-img-link" style="display: inline;"
      href="<?php echo cdn("img/engine/android/2.0/guides/in-app/open-containing-folder.png"); ?>"><img
      ...
      src="<?php echo cdn("img/engine/android/2.0/guides/in-app/open-containing-folder-800wi.png"); ?>"
      alt="Keyman-developer-open-containing-folder" border="0"/></a></p>
<p><a class="asset-img-link" style="display: inline;"
      href="<?php echo cdn("img/engine/android/2.0/guides/in-app/compiled-keyboard-file.png"); ?>"><img
      class="asset  asset-image at-xid-6a00d83432368053ef01b8d0e2f3e2970c image-full img-responsive"
      title="Compiled-keyboard-file"
      src="<?php echo cdn("img/engine/android/2.0/guides/in-app/compiled-keyboard-file-800wi.png"); ?>"
...
<p>Copy your compiled keyboard file (in this example <strong>tamil99m-1.1.js</strong>) to the
    <strong>KMSample1\KMSample1\app\src\main\assets\languages</strong> folder. You will need to create the
    <strong>assets\languages</strong> folders. If you have a font, then copy that to the
    <strong>assets\fonts</strong> folder.</p>
<p><a class="asset-img-link" style="display: inline;"
      href="<?php echo cdn("img/engine/android/2.0/guides/in-app/create-assets.png"); ?>"><img
      class="asset  asset-image at-xid-6a00d83432368053ef01bb07fe32ce970d image-full img-responsive"
      title="Create-assets"
      src="<?php echo cdn("img/engine/android/2.0/guides/in-app/create-assets-800wi.png"); ?>"
      alt="Create-assets" border="0"/></a></p>
<p><a class="asset-img-link" style="display: inline;"
      href="<?php echo cdn("img/engine/android/2.0/guides/in-app/create-fonts-languages.png"); ?>"><img
      class="asset  asset-image at-xid-6a00d83432368053ef01b8d0e3c82b970c image-full img-responsive"
      title="Create-fonts-languages"
      src="<?php echo cdn("img/engine/android/2.0/guides/in-app/create-fonts-languages-800wi.png"); ?>"
      alt="Create-fonts-languages" border="0"/></a></p>
<p><a class="asset-img-link" style="display: inline;"
      href="<?php echo cdn("img/engine/android/2.0/guides/in-app/copy-keyboard-file.png"); ?>"><img
      class="asset  asset-image at-xid-6a00d83432368053ef01b8d0e3c836970c image-full img-responsive"
      title="Copy-keyboard-file"
      src="<?php echo cdn("img/engine/android/2.0/guides/in-app/copy-keyboard-file-800wi.png"); ?>"
      alt="Copy-keyboard-file" border="0"/></a></p>
<p>If you've created the folder in the right location, when you switch back into Android Studio, you should see an
    assets folder appear with your keyboard and font files:</p>
<p><a class="asset-img-link" style="display: inline;"
      href="<?php echo cdn("img/engine/android/2.0/guides/in-app/android-studio-assets.png"); ?>"><img
      class="asset  asset-image at-xid-6a00d83432368053ef01b7c75abaa9970b img-responsive"
      title="Android-studio-assets"
      src="<?php echo cdn("img/engine/android/2.0/guides/in-app/android-studio-assets-800wi.png"); ?>"
...
<p><a class="asset-img-link" style="display: inline;"
      href="<?php echo cdn("img/engine/android/2.0/guides/in-app/android-studio-adding-keyboard.png"); ?>"><img
      ...
      src="<?php echo cdn("img/engine/android/2.0/guides/in-app/android-studio-adding-keyboard-800wi.png"); ?>"
...
<p><a class="asset-img-link" style="display: inline;"
      href="<?php echo cdn("img/engine/android/2.0/guides/in-app/android-studio-starting-debug.png"); ?>"><img
      class="asset  asset-image at-xid-6a00d83432368053ef01b8d0e2f402970c img-responsive"
      title="Android-studio-starting-debug"
      src="<?php echo cdn("img/engine/android/2.0/guides/in-app/android-studio-starting-debug-800wi.png"); ?>"
      alt="Android-studio-starting-debug" border="0"/></a></p>
<p>Click the <strong>[...]</strong> button to add a new virtual device, and follow the prompts. Any recent emulated
    device should work fine. You will be prompted to download additional resources for the emulator when this runs.
</p>
<p><a class="asset-img-link" style="display: inline;"
      href="<?php echo cdn("img/engine/android/2.0/guides/in-app/android-emulator-tamil.png"); ?>"><img
      class="asset  asset-image at-xid-6a00d83432368053ef01b7c75abb95970b image-full img-responsive"
      title="Android-emulator-tamil"
      src="<?php echo cdn("img/engine/android/2.0/guides/in-app/android-emulator-tamil-800wi.png"); ?>"
