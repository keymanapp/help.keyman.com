...
<p><a class="asset-img-link" style="display: inline;"
    href="<?php echo cdn("img/engine/android/2.0/guides/system-keyboard/emulator-800wi.png"); ?>"><img
    class="asset  asset-image at-xid-6a00d83432368053ef01b8d0e9c7c0970c-800wi image-full img-responsive"
    title="Emulator" src="<?php echo cdn("img/engine/android/2.0/guides/system-keyboard/emulator-800wi.png"); ?>"
...
<p><a class="asset-img-link" style="display: inline;"
    href="<?php echo cdn("img/engine/android/2.0/guides/system-keyboard/add-embedded-css.png"); ?>"><img
    class="asset  asset-image at-xid-6a00d83432368053ef01b7c7604a62970b image-full img-responsive"
    title="AddEmbeddedCSS" src="<?php echo cdn("img/engine/android/2.0/guides/system-keyboard/add-embedded-css-800wi.png"); ?>"
...
<p>The CSS rules required to style your keyboard are beyond the scope of this post, but the <strong>kmwosk.css</strong>
    file included in the Keyman Developer 9.0 distribution and in the
    <a href="https://github.com/keymanapp/keyman/blob/release-web-stable-2.0/web/source/resources/osk/kmwosk.css" target="_blank">
    KeymanWeb 2.0 source</a>&nbsp;is a good place to start. See this
    <a href="http://help.keyman.com/developer/engine/web/2.0/reference/osk/classes">reference</a> for more information
...
<p><a class="asset-img-link" style="display: inline;"
    href="<?php echo cdn("img/engine/android/2.0/guides/system-keyboard/main-activity-layout-800wi.png"); ?>"><img
    class="asset  asset-image at-xid-6a00d83432368053ef01b8d0e9c8a6970c image-full img-responsive"
    title="MainActivityLayout" src="<?php echo cdn("img/engine/android/2.0/guides/system-keyboard/main-activity-layout-800wi.png"); ?>"
