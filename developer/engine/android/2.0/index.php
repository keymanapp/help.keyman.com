<?php
  $pagetitle = 'Keyman Engine for Android 2.0 Developer Support';
...
<p>Keyman Engine for Android 2.0 is a Java library for Android 4.0 and later versions which enables a fully customisable keyboard layout, both within an app and system-wide.
