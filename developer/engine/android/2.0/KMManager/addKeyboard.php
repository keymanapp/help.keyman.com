<?php
    ...
    $param1 = 'context';
    $param2 = 'keyboardInfo';
    $methodSyntax = sprintf('<var>%s</var>.%s(<var>Context %s</var>, <var>HashMap&ltString, String&gt %s</var>)', $class, $method, $param1, $param2);
...
<dd>A dictionary of keyboard information with keys and values defined as <code>HashMap&ltString key, String value&gt</code>.</dd>
</dl>
