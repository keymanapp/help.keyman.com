...
<p>Returns keyboards list as <code>ArrayList&ltHashMap&ltString key, String value&gt&gt</code> if it exists, <code>null</code> otherwise.</p>
...
<pre class="language-javascript line-numbers"><code>    ArrayList&ltHashMap&ltString, String&gt&gt keyboardsList = KMManager.getKeyboardsList(this);
    if (keyboardsList != null) {
        int length = keyboardsList.size();
        for (int i = 0; i < length; i++) {
            HashMap&ltString, String&gt keyboardInfo = keyboardsList.get(i);
