<?php
  $pagetitle = 'Keyman Engine for Android 11.0 Developer Support';
...
<p>Keyman Engine for Android 11.0 is a Java library for Android 4.1 and later versions which enables a fully customisable keyboard layout, both within an app and system-wide.
Keyboard layouts for Keyman Engine can be created with <a href='/developer/current-version'>Keyman Developer</a>, and a <a href='https://keyman.com/developer/keymanweb/keyboards.php'>library of existing keyboard layouts</a>
is also available.</p>
