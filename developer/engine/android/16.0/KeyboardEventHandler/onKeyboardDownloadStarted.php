<?php
    ...
    $param1 = 'keyboardInfo';
    $eventSyntax = sprintf('public void %s(<var>HashMap&lt;String key, String value&gt; %s</var>)', $event, $param1);
    head(['title' => $event.'()']);
?>

<h1>onKeyboardDownloadStarted()</h1>
...
<dd>The information dictionary of the keyboard with keys and values defined as <code>HashMap&lt;String key, String value&gt;</code></code>.</dd>
</dl>
...
<ul>
 <li><a href="onKeyboardDownloadFinished" title="Title."><code>onKeyboardDownloadFinished()</code></a></li>
</ul>
