<?php
    ...
    $class = '';
    $event = 'onLexicalModelInstalled';
    $param1 = 'lexicalModelsInstalled';
    $eventSyntax = sprintf('public void %s(List&lt;<var>HashMap&lt;String key, String value&gt;&gt; %s</var>)', $event, $param1);
    head(['title' => $event.'()']);
?>

<h1>onLexicalModelInstalled()</h1>

<h2 id="Summary" name="Summary">Summary</h2>
<p>The <code><strong><?php echo $event.'()' ?></strong></code> event is called when a lexical-model package has been installed.</p>
...
<dd>The information dictionaries of the lexical-models installed from a lexical-model package with keys and values defined as <code>List&lt;HashMap&lt;String key, String value&gt;&gt;</code>.</dd>
</dl>

<h2 id="Description" name="Description">Description</h2>
<p>Implement this method to handle lexical-model package installed event.</p>
...
<ul>
 <li><a href="onPackageInstalled.php" title="Title."><code>onPackageInstalled()</code></a></li>
</ul>
