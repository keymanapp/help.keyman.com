...
<h1>KMManager.getKeyboardState()</h1>
...
<p>Use this method to get the state of the specified keyboard. It returns <code>KEYBOARD_STATE_UNDEFINED</code>
  if keyboardID or languageID is not specified (<code>null</code> or empty string).
  It returns <code>KEYBOARD_STATE_NEEDS_DOWNLOAD</code> if the specified keyboard does not exist in
  <code>assets/languages/</code> folder. In all other cases it returns either <code>KEYBOARD_STATE_UP_TO_DATE</code> or
  <code>KEYBOARD_STATE_NEEDS_UPDATE</code>. Note: Only keyboards provided by Keyman may return
...
<pre class="language-javascript line-numbers"><code>    KeyboardState keyboardState = KMManager.getKeyboardState(this, "tamil99m", "ta");
