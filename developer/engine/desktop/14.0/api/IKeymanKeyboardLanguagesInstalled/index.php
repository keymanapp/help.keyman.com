...
<dl>
  ...
  <dd><b>Deprecated in 14.0.</b> Associates the keyboard layout with the referenced BCP 47 language code in Windows, and if necessary installs the language as well.</dd>
</dl>

<dl>
  <dt><a href='InstallByLangID'><code>InstallByLangID()</code></a></dt>
  <dd><b>Deprecated in 14.0.</b> Associates the keyboard layout with the referenced legacy LANGID language code in Windows, and if necessary installs the language as well.</dd>
</dl>
