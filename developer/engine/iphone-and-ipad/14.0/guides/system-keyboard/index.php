...
<p><a class="asset-img-link" style="display: inline;"
      href="<?php echo cdn("img/engine/ios/14.0/guides/system-keyboard/set-sys-kbd.png"); ?>"><img
        class="asset  asset-image at-xid-6a00d83432368053ef01b8d0e9c7c0970c-800wi image-full img-responsive"
        title="Emulator" src="<?php echo cdn("img/engine/ios/14.0/guides/system-keyboard/set-sys-kbd.png"); ?>"
...
<p><a class="asset-img-link" style="display: inline;"
      href="<?php echo cdn("img/engine/ios/14.0/guides/system-keyboard/sys-kbd-active.png"); ?>"><img
        class="asset  asset-image at-xid-6a00d83432368053ef01b8d0e9c7c0970c-800wi image-full img-responsive"
        title="Emulator" src="<?php echo cdn("img/engine/ios/14.0/guides/system-keyboard/sys-kbd-active.png"); ?>"
        alt="Emulator" border="0"/></a></p>
...
<p><a class="asset-img-link" style="display: inline;"
      href="<?php echo cdn("img/engine/ios/14.0/guides/system-keyboard/developer-add-css.png"); ?>"><img
        class="asset  asset-image at-xid-6a00d83432368053ef01b7c7604a62970b image-full img-responsive"
        title="AddEmbeddedCSS" src="<?php echo cdn("img/engine/ios/14.0/guides/system-keyboard/developer-add-css-800wi.png"); ?>"
...
<p>The CSS rules required to style your keyboard are beyond the scope of this post, but the <strong>kmwosk.css</strong>
  ...
  <a href="http://help.keyman.com/developer/engine/web/14.0/reference/osk/classes">reference</a> for more information
...
<ol>
  ...
  <a href="https://github.com/keymanapp/keyman/blob/stable-14.0/ios/keyman/Keyman/SWKeyboard/ImageBannerViewController.swift">Keyman's implementation</a>
