...
<p><a class="asset-img-link" style="display: inline;"
      href="<?php echo cdn("img/engine/ios/14.0/guides/system-keyboard/set-sys-kbd-800wi.png"); ?>"><img
        class="asset  asset-image at-xid-6a00d83432368053ef01b8d0e9c7c0970c-800wi image-full img-responsive"
        title="Emulator" src="<?php echo cdn("img/engine/ios/14.0/guides/system-keyboard/set-sys-kbd-800wi.png"); ?>"
...
<p><a class="asset-img-link" style="display: inline;"
      href="<?php echo cdn("img/engine/ios/14.0/guides/system-keyboard/sys-kbd-active.png"); ?>"><img
        class="asset  asset-image at-xid-6a00d83432368053ef01b8d0e9c7c0970c-800wi image-full img-responsive"
        title="Emulator" src="<?php echo cdn("img/engine/ios/14.0/guides/system-keyboard/sys-kbd-active-800wi.png"); ?>"
        alt="Emulator" border="0"/></a></p>
