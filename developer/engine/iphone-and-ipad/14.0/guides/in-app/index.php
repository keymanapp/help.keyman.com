...
<p><a class="asset-img-link" style="display: inline;"
      href="<?php echo cdn("img/engine/ios/14.0/guides/in-app/keyboard-resource-finder.png"); ?>"><img
        class="asset  asset-image at-xid-6a00d83432368053ef01b8d0e3c836970c image-full img-responsive"
        title="Copy-keyboard-file"
        src="<?php echo cdn("img/engine/ios/14.0/guides/in-app/keyboard-resource-finder-800wi.png"); ?>"
...
<p><a class="asset-img-link" style="display: inline;"
      href="<?php echo cdn("img/engine/ios/14.0/guides/in-app/import-keyboard-in-xcode.png"); ?>"><img
        class="asset  asset-image at-xid-6a00d83432368053ef01b7c75abaa9970b img-responsive"
        title="Android-studio-assets"
        src="<?php echo cdn("img/engine/ios/14.0/guides/in-app/import-keyboard-in-xcode-800wi.png"); ?>"
...
<p><a class="asset-img-link" style="display: inline;"
      href="<?php echo cdn("img/engine/ios/14.0/guides/in-app/keyboard-load-code.png"); ?>"><img
        ...
        src="<?php echo cdn("img/engine/ios/14.0/guides/in-app/keyboard-load-code-800wi.png"); ?>"
...
<p><a class="asset-img-link" style="display: inline;"
      href="<?php echo cdn("img/engine/ios/14.0/guides/in-app/ios-simulator-tamil.png"); ?>"><img
        ...
        src="<?php echo cdn("img/engine/ios/14.0/guides/in-app/ios-simulator-tamil-800wi.png"); ?>"
