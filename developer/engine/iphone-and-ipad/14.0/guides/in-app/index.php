...
<p><a class="asset-img-link" style="display: inline;"
      href="<?php echo cdn("img/engine/ios/14.0/guides/in-app/keyboard-layout-in-developer.png"); ?>"><img
        class="asset asset-image at-xid-6a00d83432368053ef01b7c759d462970b image-full img-responsive"
        title="Keyman-developer"
        src="<?php echo cdn("img/engine/ios/14.0/guides/in-app/keyboard-layout-in-developer-800wi.png"); ?>"
...
<p><a class="asset-img-link" style="display: inline;"
      href="<?php echo cdn("img/engine/ios/14.0/guides/in-app/find-package-via-developer.png"); ?>"><img
        ...
        src="<?php echo cdn("img/engine/ios/14.0/guides/in-app/find-package-via-developer-800wi.png"); ?>"
        alt="Keyman-developer-open-containing-folder" border="0"/></a></p>
<p><a class="asset-img-link" style="display: inline;"
      href="<?php echo cdn("img/engine/ios/14.0/guides/in-app/package-file.png"); ?>"><img
        class="asset  asset-image at-xid-6a00d83432368053ef01b8d0e2f3e2970c image-full img-responsive"
        title="Compiled-keyboard-file"
        src="<?php echo cdn("img/engine/ios/14.0/guides/in-app/package-file-800wi.png"); ?>"
...
<p><a class="asset-img-link" style="display: inline;"
      href="<?php echo cdn("img/engine/ios/14.0/guides/in-app/package-import.png"); ?>"><img
        class="asset  asset-image at-xid-6a00d83432368053ef01b8d0e3c836970c image-full img-responsive"
        title="Copy-keyboard-file"
        src="<?php echo cdn("img/engine/ios/14.0/guides/in-app/package-import.png"); ?>"
...
<p><a class="asset-img-link" style="display: inline;"
      href="<?php echo cdn("img/engine/ios/14.0/guides/in-app/xcode-package-import.png"); ?>"><img
        class="asset  asset-image at-xid-6a00d83432368053ef01b7c75abaa9970b img-responsive"
        title="Android-studio-assets"
        src="<?php echo cdn("img/engine/ios/14.0/guides/in-app/xcode-package-import-800wi.png"); ?>"
...
<p><a class="asset-img-link" style="display: inline;"
      href="<?php echo cdn("img/engine/ios/14.0/guides/in-app/fully-imported.png"); ?>"><img
        ...
        src="<?php echo cdn("img/engine/ios/14.0/guides/in-app/fully-imported-800wi.png"); ?>"
...
<p><a class="asset-img-link" style="display: inline;"
      href="<?php echo cdn("img/engine/ios/14.0/guides/in-app/ios-simulator-tamil.png"); ?>"><img
        class="asset  asset-image at-xid-6a00d83432368053ef01b7c75abb95970b image-full img-responsive"
        title="Android-emulator-tamil"
        src="<?php echo cdn("img/engine/ios/14.0/guides/in-app/ios-simulator-tamil.png"); ?>"
...
<ul>
  ...
  <li><a href="/developer/engine/iphone-and-ipad/14.0/">Keyman Engine for iPhone and iOS Documentation</a></li>
