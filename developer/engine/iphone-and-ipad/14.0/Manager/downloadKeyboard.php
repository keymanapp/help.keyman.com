...
<p>The <code><strong><?= $method.'()' ?></strong></code> method installs keyboards for active use.</p>
...
<p>The following script illustrates the use of <code><?php echo $method.'()' ?></code>:</p>
<pre class="language-swift"><code>let url = URL(string: "https://example.com/keyboard.kmp")
