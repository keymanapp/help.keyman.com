...
<p><a class="asset-img-link" style="display: inline;"
      href="<?php echo cdn("img/engine/ios/13.0/guides/system-keyboard/set-sys-kbd-800wi.png"); ?>"><img
        class="asset  asset-image at-xid-6a00d83432368053ef01b8d0e9c7c0970c-800wi image-full img-responsive"
        title="Emulator" src="<?php echo cdn("img/engine/ios/13.0/guides/system-keyboard/set-sys-kbd-800wi.png"); ?>"
...
<p><a class="asset-img-link" style="display: inline;"
      href="<?php echo cdn("img/engine/ios/13.0/guides/system-keyboard/sys-kbd-active.png"); ?>"><img
        class="asset  asset-image at-xid-6a00d83432368053ef01b8d0e9c7c0970c-800wi image-full img-responsive"
        title="Emulator" src="<?php echo cdn("img/engine/ios/13.0/guides/system-keyboard/sys-kbd-active-800wi.png"); ?>"
        alt="Emulator" border="0"/></a></p>
...
<p>The CSS rules required to style your keyboard are beyond the scope of this post, but the <strong>kmwosk.css</strong>
  ...
  <a href="https://github.com/keymanapp/keyman/blob/master/web/source/resources/osk/kmwosk.css" target="_blank">
    KeymanWeb 13.0 source</a>&nbsp;is a good place to start. See this
  <a href="http://help.keyman.com/developer/engine/web/13.0/reference/osk/classes">reference</a> for more information
