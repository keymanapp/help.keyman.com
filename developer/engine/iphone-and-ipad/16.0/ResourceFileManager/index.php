...
<dl>
    <dt><code><a href='installedPackages'>installedPackages: [KeymanPackage]</a></code></dt>
...
<dl>
    ...
    <dt><code><a href='install'>install(resourceWithID: LanguageResourceFullID, from: KeymanPackage)</a></code></dt>
    <dd>Installs specified resources from opened package files for use within the KeymanEngine.</dd>
    <dt><code><a href='prepareKMPInstall'>prepareKMPInstall(from: URL)</a></code></dt>
