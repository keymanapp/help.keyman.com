...
?>
    ...
    <table width="100%" summary="Navigation header">
      ...
      <tr>
        <td width="20%" align="left">
          <a accesskey="p" href="../guide/guide_kmw_automatic_control">Prev</a>
        </td>

        <th width="60%" align="center">KeymanWeb Guide</th>

        <td width="20%" align="right">
           <a accesskey="n" href="../guide/guide_kmw_manual_control">Next</a>
        </td>
      </tr>
    </table>
    <hr>
  ...
  <div class="section" lang="en">
    ...
    <p>A working example can be seen online at <a class="ulink" href="http://www.keymanweb.com/dev/automatic_control_loaded" target=
