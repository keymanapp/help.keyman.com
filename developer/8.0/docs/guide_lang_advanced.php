<?php
  ...
  head([
    'title' => "Programmer's Guide - Advanced Keyboard Creation"
  ,'css' => ['template.css','keyboard.css','keys.css']]);
?>
<div class="navheader"><table width="100%" summary="Navigation header"><tr><th colspan="3" align="center">Programmer's Guide - Advanced Keyboard Creation</th></tr><tr><td width="20%" align="left"><a accesskey="p" href="index_guide_language.php">Prev</a> </td><th width="60%" align="center">Keyman Keyboard Language Guide</th><td width="20%" align="right"> <a accesskey="n" href="guide_lang_constraints.php">Next</a></td></tr></table><hr></div><div class="section" lang="en"><div class="titlepage"><div><div><h3 class="title" id="guide_lang_advanced">Programmer's Guide - Advanced Keyboard Creation</h3></div></div></div><h4><a name="id590944"></a>Introduction</h4><p>
    ...
    see <a class="ulink" href="http://www2.arts.gla.ac.uk/IPA/ipa.html" target="_blank">The International Phonetic Association</a>.
  </p><p>
    ...
    <span class="inlinemediaobject"><img src="developer_images/ipa.gif"></span>
  </p><h4><a name="id590886"></a>Overview of the Keyboard</h4><p>
...
store( o_chars ) 'o--' dk(o_err) dk(o_err) dk(o_err) dk(o_err) dk(o_err) dk(o_err) dk(o_err)
  ...
  </p><h4><a name="id590822"></a>Primary Operation of the Keyboard</h4><p>
  ...
  </p><h4><a name="id590758"></a>Error Handling</h4><p>
  ...
  </p><h4><a name="id590736"></a>Conclusion</h4><p>
