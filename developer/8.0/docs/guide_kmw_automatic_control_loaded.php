...
?>
<div class="navheader"><table width="100%" summary="Navigation header"><tr><th colspan="3" align="center">Automatic Control (pre-loaded) Example</th></tr><tr><td width="20%" align="left"><a accesskey="p" href="guide_kmw_automatic_control.php">Prev</a> </td><th width="60%" align="center">KeymanWeb Guide</th><td width="20%" align="right"> <a accesskey="n" href="guide_kmw_manual_control.php">Next</a></td></tr></table><hr></div><div class="section" lang="en"><div class="titlepage"><div><div><h3 class="title" id="guide_kmw_automatic_control_loaded">Automatic Control (pre-loaded) Example</h3></div></div></div><p>This page shows the simplest method of utilising KeymanWeb.  Only one tag per keyboard, plus the reference
to KeymanWeb itself, is required.</p><p>In this example, we use only the LaoKey keyboard, and we load it at the time that the page loads.</p><p>A working example can be seen online at <a class="ulink" href="http://www.keymanweb.com/dev/automatic_control_loaded.php" target="_blank">www.keymanweb.com</a></p><span class="inlinemediaobject"><img src="developer_images/kmw_automatic_control.png"></span><h4><a name="id589938"></a>Code Walkthrough</h4><pre class="programlisting">
&lt;head&gt;  
  &lt;!-- Start of Code --&gt;  
