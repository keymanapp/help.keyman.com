...
call(%snStore%)
  ...
  </p><h5><a name="id597387"></a>Example</h5><pre class="programlisting">
store(DLLFunction) "myimx.dll:KeyEvent"
+ 'a' &gt; call(DLLFunction)
      </pre><h5><a name="id596723"></a>KeymanWeb Support</h5><p>
