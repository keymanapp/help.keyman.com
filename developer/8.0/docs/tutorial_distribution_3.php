...
<div class="navheader"><table width="100%" summary="Navigation header"><tr><th colspan="3" align="center">Step 3: Fill in details about the distribution</th></tr><tr><td width="20%" align="left"><a accesskey="p" href="tutorial_distribution_2.php">Prev</a> </td><th width="60%" align="center">Distribution Tutorial</th><td width="20%" align="right"> <a accesskey="n" href="tutorial_distribution_4.php">Next</a></td></tr></table><hr></div><div class="section" lang="en"><div class="titlepage"><div><div><h3 class="title" id="tutorial_distribution_3">Step 3: Fill in details about the distribution</h3></div></div></div><p>
  ...
  </p><h4><a name="id645595"></a>EULA</h4><p>
    ...
    Tavultesoft Support for further information.
      ...
      your product.
    </p></div><h4><a name="id645631"></a>Other Fields</h4><p>The Copyright, Author, Email and Website fields must be completed.</p><h4><a name="id645639"></a>Locale Folder</h4><p>
