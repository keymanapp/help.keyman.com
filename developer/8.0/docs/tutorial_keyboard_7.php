...
?>
<div class="navheader"><table width="100%" summary="Navigation header"><tr><th colspan="3" align="center">Step 7: Testing the Keyboard</th></tr><tr><td width="20%" align="left"><a accesskey="p" href="tutorial_keyboard_6.php">Prev</a> </td><th width="60%" align="center">Keyboard Tutorial</th><td width="20%" align="right"> <a accesskey="n" href="tutorial_keyboard_8.php">Next</a></td></tr></table><hr></div><div class="section" lang="en"><div class="titlepage"><div><div><h3 class="title" id="tutorial_keyboard_7">Step 7: Testing the Keyboard</h3></div></div></div><h4><a name="id662358"></a>Compiling the Keyboard</h4><p>
  ...
  </p><h4><a name="id662376"></a>Compiling the Keyboard</h4><p>
