...
<div class="navheader"><table width="100%" summary="Navigation header"><tr><th colspan="3" align="center">keyman.xsl: Keyman Desktop Configuration Window</th></tr><tr><td width="20%" align="left"><a accesskey="p" href="reference_branding_installkeyboard.php">Prev</a> </td><th width="60%" align="center">Reference - Branding Toolkit for Keyman Developer Professional</th><td width="20%" align="right"> <a accesskey="n" href="reference_branding_keyman_addins.php">Next</a></td></tr></table><hr></div><div class="section" lang="en"><div class="titlepage"><div><div><h3 class="title" id="reference_branding_keyman">keyman.xsl: Keyman Desktop Configuration Window</h3></div></div></div><p>
    ...
    and so it has been split into several separate files:
      ...
      </p></li></ul></div><h4><a name="id669816"></a>XML Parameters</h4><p>
...
&lt;div id="state"&gt;&lt;xsl:value-of select="state"/&gt;&lt;/div&gt;
  ...
  </p><h4><a name="id669839"></a>Targets</h4><p>The targets available for Keyman Desktop Configuration are listed on the pages above.  Other general targets are:</p><table id="id669846"><tr>
      <th>Target</th>
      <th>Parameters</th>
      <th>Description</th>
    </tr><tr>
