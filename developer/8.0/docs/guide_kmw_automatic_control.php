...
<div class="navheader"><table width="100%" summary="Navigation header"><tr><th colspan="3" align="center">Automatic Mode Example</th></tr><tr><td width="20%" align="left"><a accesskey="p" href="index_guide_kmw.php">Prev</a> </td><th width="60%" align="center">KeymanWeb Guide</th><td width="20%" align="right"> <a accesskey="n" href="guide_kmw_automatic_control_loaded.php">Next</a></td></tr></table><hr></div><div class="section" lang="en"><div class="titlepage"><div><div><h3 class="title" id="guide_kmw_automatic_control">Automatic Mode Example</h3></div></div></div><p>
    ...
    <span class="inlinemediaobject"><img src="developer_images/kmw_automatic_control.png"></span>
  </p><h4><a name="id591026"></a>Code Walkthrough</h4><pre class="programlisting">
&lt;head&gt;  
  &lt;!-- Start of Code --&gt;  
...
&lt;/head&gt;
  ...
  </p><h4><a name="id591142"></a>The KeymanWeb_Key</h4><p>
