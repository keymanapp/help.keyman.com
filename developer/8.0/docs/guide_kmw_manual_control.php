...
?>
<div class="navheader"><table width="100%" summary="Navigation header"><tr><th colspan="3" align="center">Manual Control Example</th></tr><tr><td width="20%" align="left"><a accesskey="p" href="guide_kmw_automatic_control_loaded.php">Prev</a> </td><th width="60%" align="center">KeymanWeb Guide</th><td width="20%" align="right"> <a accesskey="n" href="guide_kmw_full_manual_control.php">Next</a></td></tr></table><hr></div><div class="section" lang="en"><div class="titlepage"><div><div><h3 class="title" id="guide_kmw_manual_control">Manual Control Example</h3></div></div></div><p>
    In this example, the web page designer specifies the location and activation of the user interface for
    the KeymanWeb.  They have also specified that the LaoKeys keyboard should be activated by default.
    This example continues to use the KeymanWeb default interface.
  </p><p>A working example can be seen online at <a class="ulink" href="http://www.keymanweb.com/dev/manual_control.php" target="_blank">www.keymanweb.com</a></p><span class="inlinemediaobject"><img src="developer_images/kmw_manual_control.png"></span><h4><a name="id589499"></a>Code Walkthrough</h4><p>Include the following script in the HEAD of your page:</p><pre class="programlisting">
...
&lt;body onload="SetupDocument()"&gt;
  </pre><p>And finally, include the control img for KeymanWeb:</p><pre class="programlisting">
...
&lt;img style="border: solid 1px black; padding: 2px 2px 3px 2px" src='kmicon.png' alt='KeymanWeb' onclick='KWControlClick()' id='KWControl' /&gt;
  </pre></div><div class="navfooter"><hr><table width="100%" summary="Navigation footer"><tr><td width="40%" align="left"><a accesskey="p" href="guide_kmw_automatic_control_loaded.php">Prev</a> </td><td width="20%" align="center"><a accesskey="u" href="index_guide_kmw.php">Up</a></td><td width="40%" align="right"> <a accesskey="n" href="guide_kmw_full_manual_control.php">Next</a></td></tr><tr><td width="40%" align="left" valign="top">Automatic Control (pre-loaded) Example </td><td width="20%" align="center"><a accesskey="h" href="index.php">Home</a></td><td width="40%" align="right" valign="top"> Full Manual Control Example</td></tr></table></div>
