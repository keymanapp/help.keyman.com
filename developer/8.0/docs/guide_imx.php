...
<div class="navheader"><table width="100%" summary="Navigation header"><tr><th colspan="3" align="center">DLL Interface for Keyman - Introduction</th></tr><tr><td width="20%" align="left"><a accesskey="p" href="guide_imx_imxdll.php">Prev</a> </td><th width="60%" align="center">IMX Developers Guide</th><td width="20%" align="right"> <a accesskey="n" href="guide_imx_imxlib.php">Next</a></td></tr></table><hr></div><div class="section" lang="en"><div class="titlepage"><div><div><h3 class="title" id="guide_imx">DLL Interface for Keyman - Introduction</h3></div></div></div><p>
      ...
      </p><h4><a name="id643956"></a>File locations</h4><p>
      ...
      </p><p>Full x64 support for IMX DLLs was introduced in Keyman Desktop 8.0.333.0.  An x64 version of the DLL may be included simply by giving it the file extension .x64.dll, with the same base name as the x86 DLL.  Keyman will call the appropriate DLL.</p><h4><a name="id643936"></a>General usage information</h4><p>
      ...
      </p><h4><a name="id643915"></a>Registry settings</h4><p>
        ...
        other dll values.
      </p><h4><a name="id643897"></a>The .kmn interface</h4><p>
