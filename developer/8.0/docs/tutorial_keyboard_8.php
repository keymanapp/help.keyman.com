...
?>
<div class="navheader"><table width="100%" summary="Navigation header"><tr><th colspan="3" align="center">Step 8: Deadkeys</th></tr><tr><td width="20%" align="left"><a accesskey="p" href="tutorial_keyboard_7.php">Prev</a> </td><th width="60%" align="center">Keyboard Tutorial</th><td width="20%" align="right"> <a accesskey="n" href="tutorial_keyboard_9.php">Next</a></td></tr></table><hr></div><div class="section" lang="en"><div class="titlepage"><div><div><h3 class="title" id="tutorial_keyboard_8">Step 8: Deadkeys</h3></div></div></div><h4><a name="id662430"></a>Solving the Problem</h4><p>
...
"'" + "'" &gt; "'"
    ...
    we use deadkeys.
  </p><h4><a name="id662444"></a>Deadkeys</h4><p>
