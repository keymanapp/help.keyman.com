...
?>
<div class="navheader"><table width="100%" summary="Navigation header"><tr><th colspan="3" align="center">Full Manual Control Example</th></tr><tr><td width="20%" align="left"><a accesskey="p" href="guide_kmw_manual_control.php">Prev</a> </td><th width="60%" align="center">KeymanWeb Guide</th><td width="20%" align="right"> <a accesskey="n" href="guide_kmw_control_by_control.php">Next</a></td></tr></table><hr></div><div class="section" lang="en"><div class="titlepage"><div><div><h3 class="title" id="guide_kmw_full_manual_control">Full Manual Control Example</h3></div></div></div><p>
    ...
    <span class="inlinemediaobject"><img src="developer_images/kmw_full_manual_control.png"></span>
  </p><h4><a name="id643564"></a>Code Walkthrough</h4><p>Include the following script in the HEAD of your page:</p><pre class="programlisting">
var KWControl = null;
