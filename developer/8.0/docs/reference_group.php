...
group(%gnGroup%) [using keys]
      ...
      </p><h5><a name="id596292"></a>Example</h5><pre class="programlisting">
group(main) using keys
group(syllablecheck)
      </pre><h5><a name="id597519"></a>Versions</h5><p>The group construct was introduced in Keyman 5.0.</p><h5><a name="id597247"></a>Related Topics</h5><div class="itemizedlist"><ul type="disc"><li><p><a class="xref" href="reference__struct_groups.php" title="Using Groups">Using Groups</a></p></li><li><p><a class="xref" href="reference__struct.php" title="Language Structure">Language Structure</a></p></li></ul></div></div><div class="navfooter"><hr><table width="100%" summary="Navigation footer"><tr><td width="40%" align="left"><a accesskey="p" href="reference_deadkey.php">Prev</a> </td><td width="20%" align="center"><a accesskey="u" href="reference_statements_index.php">Up</a></td><td width="40%" align="right"> <a accesskey="n" href="reference_if.php">Next</a></td></tr><tr><td width="40%" align="left" valign="top">deadkey statement </td><td width="20%" align="center"><a accesskey="h" href="index.php">Home</a></td><td width="40%" align="right" valign="top"> if statement</td></tr></table></div>
