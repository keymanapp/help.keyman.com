<?php
  ...
  head([
    'title' => "Programmer's Guide - Constraints"
  ,'css' => ['template.css','keyboard.css','keys.css']]);
?>
<div class="navheader"><table width="100%" summary="Navigation header"><tr><th colspan="3" align="center">Programmer's Guide - Constraints</th></tr><tr><td width="20%" align="left"><a accesskey="p" href="guide_lang_advanced.php">Prev</a> </td><th width="60%" align="center">Keyman Keyboard Language Guide</th><td width="20%" align="right"> <a accesskey="n" href="guide_lang_groups.php">Next</a></td></tr></table><hr></div><div class="section" lang="en"><div class="titlepage"><div><div><h3 class="title" id="guide_lang_constraints">Programmer's Guide - Constraints</h3></div></div></div><p>
  ...
  </p><h4><a name="id590715"></a>Rejecting keystrokes</h4><p>
...
+ "Q" &gt; beep
  ...
  </p><h4><a name="id590661"></a>Rejecting keystrokes after a context</h4><p>
...
"ba" + "d" &gt; context beep
  </pre><h4><a name="id590636"></a>Rejecting both context and keystroke</h4><p>
...
"eras" + "e" &gt; beep
  </pre><h4><a name="id590601"></a>Typical usage of constraints</h4><p>
  ...
  </p><h4><a name="id590553"></a>Related Topics</h4><div class="itemizedlist"><ul type="disc"><li><p>
