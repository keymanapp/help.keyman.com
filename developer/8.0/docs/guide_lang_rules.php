<?php
  ...
  head([
    'title' => "Programmer's Guide - Rules"
  ,'css' => ['template.css','keyboard.css','keys.css']]);
?>
<div class="navheader"><table width="100%" summary="Navigation header"><tr><th colspan="3" align="center">Programmer's Guide - Rules</th></tr><tr><td width="20%" align="left"><a accesskey="p" href="guide_lang_groups.php">Prev</a> </td><th width="60%" align="center">Keyman Keyboard Language Guide</th><td width="20%" align="right"> <a accesskey="n" href="guide_lang_stores.php">Next</a></td></tr></table><hr></div><div class="section" lang="en"><div class="titlepage"><div><div><h3 class="title" id="guide_lang_rules">Programmer's Guide - Rules</h3></div></div></div><p>
      ...
      </p><h4><a name="id590446"></a>Using Rules</h4><p>
...
%context% + %keystroke% &gt; %output%
      ...
      </p><h4><a name="id590394"></a>context</h4><p>
...
"abc" + "d" &gt; "D" context(2)
      ...
      </p><h4><a name="id590361"></a>nul</h4><p>
...
+ '\' &gt; nul
      </pre><h4><a name="id590346"></a>beep</h4><p>
