<?php
  ...
  head([
    'title' => "Programmer's Guide - Using Groups"
  ,'css' => ['template.css','keyboard.css','keys.css']]);
?>
<div class="navheader"><table width="100%" summary="Navigation header"><tr><th colspan="3" align="center">Programmer's Guide - Using Groups</th></tr><tr><td width="20%" align="left"><a accesskey="p" href="guide_lang_constraints.php">Prev</a> </td><th width="60%" align="center">Keyman Keyboard Language Guide</th><td width="20%" align="right"> <a accesskey="n" href="guide_lang_rules.php">Next</a></td></tr></table><hr></div><div class="section" lang="en"><div class="titlepage"><div><div><h3 class="title" id="guide_lang_groups">Programmer's Guide - Using Groups</h3></div></div></div><p>
