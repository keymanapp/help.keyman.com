...
<p>Keyman Developer 10 includes full touch layout editing tools. In the image below I am editing a Khmer Angkor touch layout sample.</p>
...
<p>To start the web server and debugging session, on the <strong>Build</strong> tab of your keyboard editor, click <strong>Test Keyboard on web</strong> (we may rename these buttons in a later release to reflect the cross-platform targets here).</p>
...
<p>You will see a list of web addresses in the list box below the&nbsp;<strong>Test Keyboard on web</strong>. This lists all the computer and domain names and IP addresses that Keyman Developer is listening on that we can find. Why so many? Because of the variety of network setups, different users will need to use different addresses; Keyman Developer leaves that up to you! &nbsp;We call the list the <strong>Debug Host List</strong>.</p>
...
<p>You can test your desktop layout by selecting an address in the debug host list and clicking&nbsp;<strong>Open debugger in local browser</strong>. &nbsp;This will load the KeymanWeb Debug Host page in your browser, and you should be able to select your keyboard from the list and start using it.</p>
...
<p>Alternatively, you can click the <strong>Send addresses to email...</strong> button. It sends a list of the debug host addresses to an email address of your choice, so you can then just click the link in your email on your target device.</p>
...
<p>If you do not have Keyman currently installed on your target device, you can click <strong>Install Keyman for Android</strong> or <strong>Install Keyman for iOS</strong> to bring up the appropriate store for installing Keyman.</p>

<p>Finally, you can also install your keyboard layout directly into Keyman for Android or Keyman for iPhone and iPad by clicking the&nbsp;<strong>Add keyboard to Keyman for Android</strong> button or <strong>Add keyboard to Keyman for iOS</strong> button on the test page on your device.</p>
