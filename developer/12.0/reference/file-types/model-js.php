...
<dl>
  ...
  <dd>A .MODEL.JS file is compiled in <span class="application">Keyman Developer</span> from the Keyman lexical model
    source (<a href='model-ts'>.MODEL.TS</a>) file and (<a href="tsv">.TSV</a>) wordlist. Note that .MODEL.JS files will only work in
  ...
  <dd>This is the lexical model file. It must be distributed with your package to allow people to use the lexical model
