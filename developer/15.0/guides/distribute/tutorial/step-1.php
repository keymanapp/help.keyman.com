...
<ul type="disc">
  <li><img src="<?= cdn('img/developer/100/tutorial_package_includesfonts.gif') ?>"> includes fonts</li>
  <li><img src="<?= cdn('img/developer/100/tutorial_package_includesdocs.gif') ?>"> includes documentation</li>
  <li><img src="<?= cdn('img/developer/100/tutorial_package_includesosk.gif') ?>"> includes on screen keyboards</li>
  <li><img src="<?= cdn('img/developer/100/tutorial_package_includeswelcome.gif') ?>"> includes welcome.htm</li>
</ul>
