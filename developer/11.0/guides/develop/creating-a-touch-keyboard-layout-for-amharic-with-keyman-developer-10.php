...
<p><img src="<?= cdn('img/developer/100/touch_amharic_keyboard.png')?>"></p>
...
<p>Keyman Developer 10's Touch Layout editor greatly simplifies the process of developing the JSON layout file that specifies the
...
<p>The final tablet default keyboard layer, as displayed in the Touch Layout editor in the current release of Keyman Developer 10,
now appears as:</p>

<p><img src="<?= cdn('img/developer/100/touch_amharic_keyboard_2.png')?>"></p>
...
<p><img src="<?= cdn('img/developer/100/touch_amharic_keyboard_3.png')?>"></p>
