...
?>
  ...
  <div class="navheader">
    <table width="100%" summary="Navigation header">
      <tr>
        <th colspan="3" align="center">Changing KeymanWeb's Defaults</th>
      </tr>
  ...
  <div class="section" lang="en">
    <div class="titlepage">
      <h3 class="title" id="guide_kmw_defaults">Changing KeymanWeb's Defaults</h3>
    </div>

    <p>In this example, the web page designer specifies some additional defaults for KeymanWeb, such as the name of the non-KeymanWeb
    keyboard in the keyboard list (usually "English"), and the colour of the keycaps in the visual keyboard.</p>

    <p>Note that in general the style of the visual keyboard is controlled by CSS (see the reference documentation); however, due to bugs
    ...
    <h4><a name="id536039" id="id536039"></a>Code Walkthrough</h4>
