...
<p class='context-main-image'><img src="<?= cdn('img/developer/90/ui/frmOptions_General.png') ?>" alt="Options dialog - General tab" /></p>
...
<dl>
  ...
  selecting "Open in External Editor". The files available for editing externally are .kmn, .kps and .kpp. .kct and .kvk
  files are in a binary format and cannot be edited outside the TIKE environment. This field configures which editor you wish to
  ...
  <dt>Display theme</dt>
  <dd>Choose a display style for Keyman Developer. Sapphire Kamri is the default style.</dd>
...
<p class='context-main-image'><img src="<?= cdn('img/developer/90/ui/frmOptions_Editor.png') ?>" alt="Options dialog - Editor tab" /></p>
...
<dl>
  ...
  <dt>Quoted font</dt>
  <dd>Sets the font for displaying comments text in single or double quotes in the editor.</dd>
</dl>

<h2>Colours tab</h2>

<p class='context-main-image'><img src="<?= cdn('img/developer/90/ui/frmOptions_Colours.png') ?>" alt="Options dialog - Colours tab" /></p>

<p>Allows you to configure the syntax highlighting used in the editor window. You can set colours and font styles for each of the
different segments of code, or disable syntax highlighting.</p>

<h2>Debugger tab</h2>

<p class='context-main-image'><img src="<?= cdn('img/developer/90/ui/frmOptions_Debugger.png') ?>" alt="Options dialog - Debugger tab" /></p>
...
<p class='context-main-image'><img src="<?= cdn('img/developer/90/ui/frmOptions_CharacterMap.png') ?>" alt="Options dialog - Character Map tab" /></p>
...
<dl>
  ...
  <dd>
      ...
      lets you update the character map with a newer version of Unicode. Keyman Developer 9.0 was released with Unicode version 8.0
      data.
  </dd>
</dl>