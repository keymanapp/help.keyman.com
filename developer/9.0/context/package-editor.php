...
a set of keyboards, documentation, fonts, and other related files, which make distribution and installation of a keyboard in Keyman Desktop
simple.</p>

<h2>Files tab</h2>

<p class='context-main-image'><img src="<?= cdn('img/developer/90/ui/frmPackageEditor_Files.png') ?>" alt="Package Editor - Files tab" /></p>

<p>Use the <span class="guibutton">Add</span> button to select the files to be included in the package, such as .kmx keyboard files,
...
<p class='context-main-image'><img src="<?= cdn('img/developer/90/ui/frmPackageEditor_Details.png') ?>" alt="Package Editor - Details tab" /></p>
...
<p class='context-main-image'><img src="<?= cdn('img/developer/90/ui/frmPackageEditor_Shortcuts.png') ?>" alt="Package Editor - Shortcuts tab" /></p>
...
<p class='context-main-image'><img src="<?= cdn('img/developer/90/ui/frmPackageEditor_Source.png') ?>" alt="Package Editor - Source tab" /></p>
...
<p class='context-main-image'><img src="<?= cdn('img/developer/90/ui/frmPackageEditor_Build.png') ?>" alt="Package Editor - Compile tab" /></p>
...
<p>Once you are satisfied with your package, you should consider uploading it to Tavultesoft to share with other users.</p>
...
<p>The Keyman Desktop .msi installer is embedded in the .exe installer that can be downloaded from the Tavultesoft website. You can
extract the .msi installer using the "-x" option. For example, run "keymandesktop-9.0.510.0.exe -x ." to extract the .msi file into 
the current folder.</p>

<p>You cannot select the .exe file for this option - it must be an .msi file. If you create your own custom product using the Branding
Pack, you can also use the .msi file generated in this instance here.</p>

<p>The bootstrapper installer used for a Package Installer has several command line parameters that can be used. <a class="link" href=
"../reference/tools/setup" title="Setup Bootstrapper">More information on the bootstrapper installer</a>.</p>
