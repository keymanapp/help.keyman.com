...
<p class='context-main-image'><img src="<?= cdn('img/developer/90/ui/frmStartup.png') ?>" alt="Startup window" /></p>
...
<p>When you have registered <span class="application">Keyman Developer</span>, you can switch off the splash screen.</p>
