...
<p class='context-main-image'><img src="<?= cdn('img/developer/90/ui/frmKeymanWizard_New.png') ?>" alt="Keyboard Editor - New file, Details tab" /></p>
...
<table class='display'>
  ...
  <tbody>
    ...
    <tr>
      <td class='language-none'><code><var>file</var>.kvk</code></td>
      <td>On-Screen</td>
...
<p class='context-main-image'><img src="<?= cdn('img/developer/90/ui/frmKeymanWizard_Details.png') ?>" alt="Keyboard Editor - Details tab, part 1" /></p>

<p class='context-main-image'><img src="<?= cdn('img/developer/90/ui/frmKeymanWizard_Details_2.png') ?>" alt="Keyboard Editor - Details tab, part 2" /></p>

<p>The Details tab grows as you add more options to a keyboard. Shown above is the top half of the Details tab. The fields here are:</p>
...
<dl>
  ...
  <dt>Message</dt>
  <dd>Enter a message that will be shown at install time for the keyboard (on Windows, Mac OS X). <a href='/developer/language/reference/message'><code>&amp;message</code> store</a>.</dd>
...
<h2>JSON Metadata tab</h2>

<p class='context-main-image'><img src="<?= cdn('img/developer/90/ui/frmKeymanWizard_JSON_Design.png') ?>" alt="Keyboard Editor - JSON Metadata tab, Design view" /></p>

<p>This tab lets you create a metadata description file to assist in distribution and installation of a web or touch keyboard. It is used only for web and touch keyboards.</p>

<p>The metadata file is in JSON format, and can be processed by Keyman for iPhone and iPad, Keyman for Android, and KeymanWeb. The format is fully described in the <a href='../guides/distribute/mobile-apps'>mobile
distribution guide</a>.</p>

<p>Multiple JSON files may be created for a single keyboard. This will typically be used where a single keyboard layout is used for multiple languages, and you want each language to be identified separately.</p>
...
<dl>
  ...
  <dt>Languages</dt>
  <dd>The language (recommend 1 only) under which this keyboard will be listed in user interface. This correlates to the ISO639-3 languages entry in the Details tab, but is necessary to allow presentation of
  the keyboard as an option in a specific language before the keyboard file itself is downloaded.</dd>
</dl>

<p class='context-main-image'><img src="<?= cdn('img/developer/90/ui/frmKeymanWizard_JSON_Code.png') ?>" alt="Keyboard Editor - JSON Metadata tab, Code view" /></p>

<p>The code view shows the metadata in its source JSON format as described in the <a href='../guides/distribute/mobile-apps'>mobile distribution guide</a>.</p>

<h2>Layout tab</h2>

<p class='context-main-image'><img src="<?= cdn('img/developer/90/ui/frmKeymanWizard_Layout_Design.png') ?>" alt="Keyboard Editor - Layout tab, Design view" /></p>
...
details on the keyboard language shown within this view.</p>

<h2>On-Screen tab</h2>

<p class='context-main-image'><img src="<?= cdn('img/developer/90/ui/frmKeymanWizard_OnScreenKeyboard.png') ?>" alt="Keyboard Editor - On-Screen tab" /></p>

<p>This tab allows you to edit the visual representation of your keyboard layout. The content on this tab is stored in the .kvk file associated with your keyboard.
...
<p class='context-main-image'><img src="<?= cdn('img/developer/90/ui/frmKeymanWizard_TouchLayout_Design_2.png') ?>" alt="Keyboard Editor - Touch Layout tab, Design view closeup" /></p>
...
<dl>
  <dt>Key Type</dt>
  <dd><p>The general appearance of each key is determined by the key type, which is selected (in Keyman Developer 9) from a drop-down
  list:</p>
  ...
  <dt>Add/Remove touch+hold popup</dt>
...
<p class='context-main-image'><img src="<?= cdn('img/developer/90/ui/frmKeymanWizard_Icon.png') ?>" alt="Keyboard Editor - Icon tab" /></p>
...
<p class='context-main-image'><img src="<?= cdn('img/developer/90/ui/frmKeymanWizard_Build.png') ?>" alt="Keyboard Editor - Build tab" /></p>
...
<h3>Windows and Mac OS X Targets</h3>

<p>If your keyboard is designed to target Windows and Mac OS X, then the following buttons will also be visible:</p>
