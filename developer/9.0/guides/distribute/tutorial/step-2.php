...
<dl>
  ...
  <dd>
    ...
    <aside>
      ...
      <ul type="disc">
        ...
        <li>a link to an official distribution site for your package (even if it is the Tavultesoft website) - so that users know
    ...
    <aside>
      ...
      e.g. <code class='language-none'>&lt;a href="link:http://www.tavultesoft.com/">website&lt;/a></code></p>
    ...
    <aside>
      ...
      <p>You can include multiple "welcome.htm" files for different languages by appending a hyphen and the ISO 639-3
      language code to the filename, for example welcome-fra.htm for French.</p>
    </aside>
  </dd>
  ...
  <dd>
    <p>Add the .kmx compiled keyboard to the package. You can add multiple keyboards to the package, but be judicious.</p>

    <p>Keyman Desktop Free will only allow the user to install two keyboards. The user must decide which ones to use
    when they install the package.</p>
  ...
  <dd>
    ...
    Information on the locale.xml file format is available <a class="link" href="/developer/engine/desktop/9.0/locale/">here</a>.
  </dd>
</dl>
