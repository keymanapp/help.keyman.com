...
<p>A comment always starts with a lowercase <code>&nbsp;c </code>, followed by one or more spaces, and continues to the end of the line. Keyman
...
<h2>The <code>&amp;Version</code> store</h2>
<pre><code>store(&amp;Version) "9.0"             c This keyboard is for use with Keyman 9.0
</code></pre>

<p>The <a class="link" href="/developer/language/reference/version" title="&amp;Version store"><code>&amp;Version</code> store</a>
identifies the Keyman version for which this keyboard was written; this keyboard is for use with Keyman 7.0. The <code>&amp;Version</code>
store is a required part of each keyboard header, and should be the first store in the file.</p>

<h2>The <code>&amp;Name</code> store</h2>

<pre><code>store(&amp;Name)    "Quick French"
</code></pre>

<p>The <a class="link" href="/developer/language/reference/name" title="&amp;Name store"><code>&amp;Name</code> store</a> specifies a
descriptive name for the keyboard, which can be up to eighty characters long. The name we have given to this keyboard is 
<code>"Quick French"</code>. The <code>&amp;Name</code> store is not required but is highly recommended!</p>

<h2>The <code>&amp;Bitmap</code> store</h2>

<pre><code>store(&amp;Bitmap)  "qfrench.ico"
</code></pre>

<p>The optional <a href="/developer/language/reference/bitmap" title="&amp;Bitmap store"><code>&amp;Bitmap</code> store</a>
...
following bitmap: <img class='inline' src="<?= cdn('img/developer/90/tutorial_keyboard_qfrench.gif')?>">; it is found in
...
<h2>The <code>&amp;MnemonicLayout</code> store</h2>
<pre><code>store(&amp;MnemonicLayout) "1"
</code></pre>

<p>The <a href="/developer/language/reference/mnemoniclayout" title="&amp;mnemoniclayout store"><code>&amp;MnemonicLayout</code> store</a>
...
<h2>The <code>begin</code> statement</h2>

<pre><code>begin Unicode &gt; use(Main)
</code></pre>

<p>The <a href="/developer/language/reference/begin" title="begin statement"><code>begin</code> statement</a> tells Keyman which group of rules to
...
will use a single group, called Main. The <code>begin</code> statement is required in every keyboard, and marks the start of the keyboard body. The
<code>begin</code> statement also tells Keyman which encoding to use for the keyboard. Nearly all keyboards will use <code>Unicode</code>, today.</p>
