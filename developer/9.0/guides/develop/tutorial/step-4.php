...
title="group statement"><code>group</code> statement</a>, and ends either at the start of another group, or at the end of the keyboard file.</p>

<p>We will only use one group in the Quick French keyboard, called <code>Main</code>. We mark the start of it with the <code>group</code> statement 
below. Add this line to the keyboard.</p>

<pre><code>group(Main) using keys
</code></pre>

<p>The <code>using keys</code> clause tells Keyman that this group will process keystrokes.</p>
...
<p>In this rule, the key is <code>"a"</code>, and the output is <code>"ä"</code>. A simple rule begins with a plus sign, followed by the key,
