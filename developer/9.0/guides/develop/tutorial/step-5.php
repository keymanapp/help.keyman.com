...
<pre><code>c lowercase characters with acute accent
"'" + "a" > U+00E1
"'" + "e" > U+00E9
"'" + "i" > U+00ED
"'" + "o" > U+00F3
...
can make things simpler using stores, and the <code>any()</code> and <code>index()</code> statements.</p>

<p><a href="step-6.php" title="Step 6: Stores, 'any', and 'index'">Step 6: Stores, <code>any()</code>, and <code>index()</code></a></p>
